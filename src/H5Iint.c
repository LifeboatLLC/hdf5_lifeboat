...
H5I_dump_stats(FILE *file_ptr)
{
    ...
    fprintf(file_ptr,
            "H5I_mt_g.snum_type_info_fl_entries_reallocable                         = (%lld, %lld)\n",
    ...
    fprintf(
        file_ptr, "H5I_mt_g.num_type_info_fl_num_reallocable_update_collisions            = %lld\n",
...
H5I_dump_nz_stats(FILE *file_ptr, const char *tag)
{
    ...
    if ((unsigned long long)(atomic_load(&(H5I_mt_g.num_id_info_fl_num_reallocable_update_collisions))) >
        0ULL)
        fprintf(
            file_ptr, "H5I_mt_g.num_id_info_fl_num_reallocable_update_collisions              = %lld\n",
            (unsigned long long)(atomic_load(&(H5I_mt_g.num_id_info_fl_num_reallocable_update_collisions))));
    ...
    if ((unsigned long long)(atomic_load(&(H5I_mt_g.num_type_info_fl_num_reallocable_update_aborts))) > 0ULL)
        fprintf(
            file_ptr, "H5I_mt_g.num_type_info_fl_num_reallocable_update_aborts                = %lld\n",
            (unsigned long long)(atomic_load(&(H5I_mt_g.num_type_info_fl_num_reallocable_update_aborts))));
    ...
    if ((unsigned long long)(atomic_load(&(H5I_mt_g.num_type_info_fl_num_reallocable_update_collisions))) >
        0ULL)
        fprintf(file_ptr, "H5I_mt_g.num_type_info_fl_num_reallocable_update_collisions            = %lld\n",
                (unsigned long long)(atomic_load(
                    &(H5I_mt_g.num_type_info_fl_num_reallocable_update_collisions))));
...
H5I__discard_mt_id_info(H5I_mt_id_info_t *id_info_ptr)
{
    ...
    if (try_to_free_an_entry) {
        ...
        while ((!reallocable_entry_available) &&
               (0 <
                (num_fl_entries_reallocable = atomic_load(&(H5I_mt_g.num_id_info_fl_entries_reallocable))))) {

            assert(0 < num_fl_entries_reallocable);

            if (atomic_compare_exchange_strong(&(H5I_mt_g.num_id_info_fl_entries_reallocable),
                                               &num_fl_entries_reallocable,
                                               (num_fl_entries_reallocable - 1))) {
...
#else
        while ((!reallocable_entry_available) && (0 < (snum_fl_entries_reallocable = atomic_load(
                                                           &(H5I_mt_g.snum_type_info_fl_entries_reallocable)))
                                                          .val)) {
            ...
            if (atomic_compare_exchange_strong(&(H5I_mt_g.snum_type_info_fl_entries_reallocable),
                                               &snum_fl_entries_reallocable,
                                               new_snum_fl_entries_reallocable)) {
                ...
                fprintf(
                    ...
                    (long long)snum_fl_entries_reallocable.val, (long long)snum_fl_entries_reallocable.sn,
                ...
                if ((test_fl_shead.ptr == fl_shead.ptr) && (test_fl_shead.sn == fl_shead.sn)) {
                    ...
                    if (fl_shead.ptr == fl_stail.ptr) {
                        ...
                        if (!atomic_compare_exchange_strong(&(H5I_mt_g.type_info_fl_shead), &fl_shead,
                             ...
                             * discard *type_info_ptr, update stats, and exit the loop by setting done to
                             * true.
                             */
...
H5I__exit(void)
{
    ...
    if (1ULL == atomic_fetch_sub(&(H5I_mt_g.active_threads), 1ULL)) {
        ...
        snum_type_info_fl_entries_reallocable =
            atomic_load(&(H5I_mt_g.snum_type_info_fl_entries_reallocable));
#endif
        ...
        if ((active_threads != 0) || (pre_api_entries != post_api_entries) ||
            ...
            if (type_info_fl_len == snum_type_info_fl_entries_reallocable.val) {
...
#else
                new_snum_type_info_fl_entries_reallocable.val =
                    snum_type_info_fl_entries_reallocable.val + delta;
                ...
                if (atomic_compare_exchange_strong(&(H5I_mt_g.snum_type_info_fl_entries_reallocable),
                    ...
                    fprintf(stderr,
                            "\nexit: old/new snum_type_info_fl_entries_reallocable = {%lld, %lld} / {%lld, "
                            "%lld}\n",
