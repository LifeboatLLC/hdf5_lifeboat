...
typedef struct H5P_mt_class_t
{
    ...
    _Atomic uint64_t num_ref_count_deleted_true;
    _Atomic uint64_t num_ref_count_deleted_false;
...
typedef struct H5P_mt_list_t
{
    ...
    //_Atomic uint64_t num_search_list__found_older_curr;
    _Atomic uint64_t num_target_prop_found_but_deleted;
...
herr_t 
    H5P__find_mod_point(H5P_mt_prop_t *pl_head, H5P_mt_prop_t **first_ptr_ptr, 
                           ...
                           int64_t chksum, const char *name, uint64_t version);
H5P_mt_prop_t * 
...
uint64_t H5P__mt_enforce_serialization(void *param, uint64_t curr_version, 
