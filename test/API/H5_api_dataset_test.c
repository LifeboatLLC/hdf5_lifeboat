...
static herr_t test_create_anonymous_dataset(TestParams_t *params);
static herr_t test_create_anonymous_dataset_invalid_params(TestParams_t *params);
static herr_t test_create_dataset_null_space(TestParams_t *params);
static herr_t test_create_dataset_scalar_space(TestParams_t *params);
static herr_t test_create_zero_dim_dset(TestParams_t *params);
static herr_t test_create_dataset_random_shapes(TestParams_t *params);
static herr_t test_create_dataset_predefined_types(TestParams_t *params);
static herr_t test_create_dataset_string_types(TestParams_t *params);
static herr_t test_create_dataset_compound_types(TestParams_t *params);
static herr_t test_create_dataset_enum_types(TestParams_t *params);
static herr_t test_create_dataset_array_types(TestParams_t *params);
static herr_t test_create_dataset_creation_properties(TestParams_t *params);
static herr_t test_create_many_dataset(TestParams_t *params);
static herr_t test_open_dataset(TestParams_t *params);
static herr_t test_open_dataset_invalid_params(TestParams_t *params);
static herr_t test_close_dataset_invalid_params(TestParams_t *params);
static herr_t test_get_dataset_space_and_type(TestParams_t *params);
static herr_t test_get_dataset_space_and_type_invalid_params(TestParams_t *params);
static herr_t test_get_dataset_space_status(TestParams_t *params);
static herr_t test_get_dataset_space_status_invalid_params(TestParams_t *params);
static herr_t test_dataset_property_lists(TestParams_t *params);
static herr_t test_get_dataset_storage_size(TestParams_t *params);
static herr_t test_get_dataset_storage_size_invalid_params(TestParams_t *params);
static herr_t test_get_dataset_chunk_storage_size(TestParams_t *params);
static herr_t test_get_dataset_chunk_storage_size_invalid_params(TestParams_t *params);
static herr_t test_get_dataset_offset(TestParams_t *params);
static herr_t test_get_dataset_offset_invalid_params(TestParams_t *params);
static herr_t test_read_dataset_small_all(TestParams_t *params);
static herr_t test_read_dataset_small_hyperslab(TestParams_t *params);
static herr_t test_read_dataset_small_point_selection(TestParams_t *params);
static herr_t test_read_multi_dataset_small_all(TestParams_t *params);
static herr_t test_read_multi_dataset_small_hyperslab(TestParams_t *params);
static herr_t test_read_multi_dataset_small_point_selection(TestParams_t *params);
static herr_t test_dataset_io_point_selections(TestParams_t *params);
static herr_t test_read_dataset_invalid_params(TestParams_t *params);
static herr_t test_write_dataset_small_all(TestParams_t *params);
static herr_t test_write_dataset_small_hyperslab(TestParams_t *params);
static herr_t test_write_dataset_small_point_selection(TestParams_t *params);
static herr_t test_write_dataset_data_verification(TestParams_t *params);
static herr_t test_write_multi_dataset_small_all(TestParams_t *params);
static herr_t test_write_multi_dataset_small_hyperslab(TestParams_t *params);
static herr_t test_write_multi_dataset_small_point_selection(TestParams_t *params);
static herr_t test_write_multi_dataset_data_verification(TestParams_t *params);
static herr_t test_write_dataset_invalid_params(TestParams_t *params);
static herr_t test_dataset_string_encodings(TestParams_t *params);
static herr_t test_dataset_builtin_type_conversion(TestParams_t *params);
static herr_t test_dataset_real_to_int_conversion(TestParams_t *params);
static herr_t test_dataset_compound_partial_io(TestParams_t *params);
static herr_t test_dataset_vlen_io(TestParams_t *params);
static herr_t test_dataset_set_extent_chunked_unlimited(TestParams_t *params);
static herr_t test_dataset_set_extent_chunked_fixed(TestParams_t *params);
static herr_t test_dataset_set_extent_data(TestParams_t *params);
static herr_t test_dataset_set_extent_double_handles(TestParams_t *params);
static herr_t test_dataset_set_extent_invalid_params(TestParams_t *params);
static herr_t test_flush_dataset(TestParams_t *params);
static herr_t test_flush_dataset_invalid_params(TestParams_t *params);
static herr_t test_refresh_dataset(TestParams_t *params);
static herr_t test_refresh_dataset_invalid_params(TestParams_t *params);

/*
 * Chunking tests
 */
static herr_t test_create_single_chunk_dataset(TestParams_t *params);
static herr_t test_write_single_chunk_dataset(TestParams_t *params);
static herr_t test_create_multi_chunk_dataset(TestParams_t *params);
static herr_t test_write_multi_chunk_dataset_same_shape_read(TestParams_t *params);
static herr_t test_write_multi_chunk_dataset_diff_shape_read(TestParams_t *params);
...
static herr_t test_read_partial_chunk_all_selection(TestParams_t *params);
static herr_t test_read_partial_chunk_hyperslab_selection(TestParams_t *params);
static herr_t test_read_partial_chunk_point_selection(TestParams_t *params);

static herr_t test_get_vlen_buf_size(TestParams_t *params);
 ...
 */
static herr_t
test_create_dataset_under_root(TestParams_t *params)
{
 ...
 */
static herr_t
test_create_dataset_under_existing_group(TestParams_t *params)
{
    hid_t file_id         = H5I_INVALID_HID;
 ...
 */
static herr_t
test_create_dataset_invalid_params(TestParams_t *params)
{
    hid_t file_id         = H5I_INVALID_HID;
    hid_t container_group = H5I_INVALID_HID, group_id = H5I_INVALID_HID;
    hid_t dset_id    = H5I_INVALID_HID;
 ...
 */
static herr_t
test_create_anonymous_dataset(TestParams_t *params)
{
    hid_t file_id         = H5I_INVALID_HID;
    hid_t container_group = H5I_INVALID_HID, group_id = H5I_INVALID_HID;
    hid_t dset_id    = H5I_INVALID_HID;
 ...
 */
static herr_t
test_create_anonymous_dataset_invalid_params(TestParams_t *params)
{
    hid_t file_id         = H5I_INVALID_HID;
    hid_t container_group = H5I_INVALID_HID, group_id = H5I_INVALID_HID;
    hid_t dset_id    = H5I_INVALID_HID;
 ...
 */
static herr_t
test_create_dataset_null_space(TestParams_t *params)
{
    hid_t file_id         = H5I_INVALID_HID;
    hid_t container_group = H5I_INVALID_HID, group_id = H5I_INVALID_HID;
    hid_t dset_id    = H5I_INVALID_HID;
 ...
 */
static herr_t
test_create_dataset_scalar_space(TestParams_t *params)
{
    hid_t file_id         = H5I_INVALID_HID;
    hid_t container_group = H5I_INVALID_HID, group_id = H5I_INVALID_HID;
    hid_t dset_id    = H5I_INVALID_HID;
 ...
 */
static herr_t
test_create_zero_dim_dset(TestParams_t *params)
{
 ...
 */
static herr_t
test_create_dataset_random_shapes(TestParams_t *params)
{
    size_t i;
    hid_t  file_id         = H5I_INVALID_HID;
    hid_t  container_group = H5I_INVALID_HID, group_id = H5I_INVALID_HID;
 ...
 */
static herr_t
test_create_dataset_predefined_types(TestParams_t *params)
{
    size_t i;
    hid_t  file_id         = H5I_INVALID_HID;
    hid_t  container_group = H5I_INVALID_HID, group_id = H5I_INVALID_HID;
 ...
 */
static herr_t
test_create_dataset_string_types(TestParams_t *params)
{
    hid_t file_id         = H5I_INVALID_HID;
    hid_t container_group = H5I_INVALID_HID, group_id = H5I_INVALID_HID;
 ...
 */
static herr_t
test_create_dataset_compound_types(TestParams_t *params)
{
    size_t i, j;
    hid_t  file_id         = H5I_INVALID_HID;
    hid_t  container_group = H5I_INVALID_HID, group_id = H5I_INVALID_HID;
 ...
 */
static herr_t
test_create_dataset_enum_types(TestParams_t *params)
{
    size_t      i;
    hid_t       file_id         = H5I_INVALID_HID;
    hid_t       container_group = H5I_INVALID_HID, group_id = H5I_INVALID_HID;
 ...
 */
static herr_t
test_create_dataset_array_types(TestParams_t *params)
{
 ...
 */
static herr_t
test_create_dataset_creation_properties(TestParams_t *params)
{
    ...
    SUBTEST_BEGIN(params, "fill values")
    {
        ...
        if ((dset_id =
                 H5Dcreate2(group_id, DATASET_FILL_VALUE_TEST_DSET_NAME2, DATASET_FILL_VALUE_TEST_DOUBLE_TYPE,
                            fspace_id, H5P_DEFAULT, dcpl_id, H5P_DEFAULT)) < 0) {
        ...
        if (H5Dread(dset_id, DATASET_FILL_VALUE_TEST_DOUBLE_TYPE, H5S_ALL, H5S_ALL, H5P_DEFAULT, read_buf) <
            0) {
            printf("    couldn't read from dataset");
            TESTFRAME_TEST_ERROR(params);
        }
        ...
        if ((H5Pset_fill_value(dcpl_id, type_id, (const void *)DATASET_FILL_VALUE_TEST_STRING_FILL_VALUE)) <
            0) {
    ...
    SUBTEST_BEGIN(params, "user-defined dataset filters")
    {
        ...
        const H5Z_class2_t filter_cls[1] = {{H5Z_CLASS_T_VERS, DATASET_CREATION_PROPERTIES_TEST_UD_FILTER_ID,
                                             1, 1, DATASET_CREATION_PROPERTIES_TEST_UD_FILTER_NAME, NULL,
                                             NULL, &filter}};
        ...
        if ((dset_id =
                 H5Dopen2(group_id, DATASET_CREATION_PROPERTIES_TEST_UD_FILTER_DSET_NAME, H5P_DEFAULT)) < 0) {
            printf("    couldn't open dataset '%s'\n", DATASET_CREATION_PROPERTIES_TEST_UD_FILTER_DSET_NAME);
            TESTFRAME_TEST_ERROR(params);
        }
    ...
    SUBTEST_BEGIN(params, "dataset storage layouts")
    {
        ...
        for (i = 0; i < ARRAY_LENGTH(layouts); i++) {
            ...
            if (H5D_CHUNKED == layouts[i]) {
                ...
                if (H5Pset_chunk(dcpl_id, DATASET_CREATION_PROPERTIES_TEST_CHUNK_DIM_RANK, local_chunk_dims) <
                    0) {
 ...
 */
static herr_t
test_create_many_dataset(TestParams_t *params)
{
    hid_t         file_id         = H5I_INVALID_HID;
    hid_t         container_group = H5I_INVALID_HID, group_id = H5I_INVALID_HID;
    hid_t         dset_id      = H5I_INVALID_HID;
 ...
 */
static herr_t
test_open_dataset(TestParams_t H5_ATTR_UNUSED *params)
{
    return SKIP;
}
 ...
 */
static herr_t
test_open_dataset_invalid_params(TestParams_t *params)
{
    hid_t file_id         = H5I_INVALID_HID;
    hid_t container_group = H5I_INVALID_HID, group_id = H5I_INVALID_HID;
    hid_t dset_id    = H5I_INVALID_HID;
 ...
 */
static herr_t
test_close_dataset_invalid_params(TestParams_t *params)
{
    herr_t err_ret = -1;
    hid_t  file_id = H5I_INVALID_HID;
 ...
 */
static herr_t
test_get_dataset_space_and_type(TestParams_t *params)
{
 ...
 */
static herr_t
test_get_dataset_space_and_type_invalid_params(TestParams_t *params)
{
    hid_t file_id         = H5I_INVALID_HID;
    hid_t container_group = H5I_INVALID_HID;
    hid_t group_id        = H5I_INVALID_HID;
 ...
 */
static herr_t
test_get_dataset_space_status(TestParams_t H5_ATTR_UNUSED *params)
{
    return SKIP;
}
 ...
 */
static herr_t
test_get_dataset_space_status_invalid_params(TestParams_t H5_ATTR_UNUSED *params)
{
    return SKIP;
}
 ...
 */
static herr_t
test_dataset_property_lists(TestParams_t *params)
{
 ...
 */
static herr_t
test_get_dataset_storage_size(TestParams_t H5_ATTR_UNUSED *params)
{
    return SKIP;
}
 ...
 */
static herr_t
test_get_dataset_storage_size_invalid_params(TestParams_t H5_ATTR_UNUSED *params)
{
    return SKIP;
}
 ...
 */
static herr_t
test_get_dataset_chunk_storage_size(TestParams_t H5_ATTR_UNUSED *params)
{
    return SKIP;
}
 ...
 */
static herr_t
test_get_dataset_chunk_storage_size_invalid_params(TestParams_t H5_ATTR_UNUSED *params)
{
    return SKIP;
}
 ...
 */
static herr_t
test_get_dataset_offset(TestParams_t H5_ATTR_UNUSED *params)
{
    return SKIP;
}
 ...
 */
static herr_t
test_get_dataset_offset_invalid_params(TestParams_t H5_ATTR_UNUSED *params)
{
    return SKIP;
}
 ...
 */
static herr_t
test_read_dataset_small_all(TestParams_t *params)
{
 ...
 */
static herr_t
test_read_dataset_small_hyperslab(TestParams_t *params)
{
 ...
 */
static herr_t
test_read_dataset_small_point_selection(TestParams_t *params)
{
 ...
 */
static herr_t
test_read_multi_dataset_small_all(TestParams_t *params)
{
 ...
 */
static herr_t
test_read_multi_dataset_small_hyperslab(TestParams_t *params)
{
    hsize_t start[DATASET_SMALL_READ_TEST_HYPERSLAB_DSET_SPACE_RANK];
    hsize_t stride[DATASET_SMALL_READ_TEST_HYPERSLAB_DSET_SPACE_RANK];
    hsize_t count[DATASET_SMALL_READ_TEST_HYPERSLAB_DSET_SPACE_RANK];
 ...
 */
static herr_t
test_read_multi_dataset_small_point_selection(TestParams_t *params)
{
    hsize_t points[DATASET_SMALL_READ_TEST_POINT_SELECTION_NUM_POINTS *
                   DATASET_SMALL_READ_TEST_POINT_SELECTION_DSET_SPACE_RANK];
    hsize_t dims[DATASET_SMALL_READ_TEST_POINT_SELECTION_DSET_SPACE_RANK] = {10, 10, 10};
...
static herr_t
test_dataset_io_point_selections(TestParams_t *params)
{
    hid_t   file_id         = H5I_INVALID_HID;
    hid_t   dset_id         = H5I_INVALID_HID;
    hid_t   container_group = H5I_INVALID_HID, group_id = H5I_INVALID_HID;
    ...
    for (do_chunk = false;; do_chunk = true) {
        if (do_chunk) {
            ...
            SUBTEST_BEGIN(
                params, "point selection I/O with all selection in memory and points in file with chunking");
        ...
        if (H5Dwrite(dset_id, H5T_NATIVE_INT, H5S_ALL, H5S_ALL, H5P_DEFAULT, buf_all) < 0)
            TESTFRAME_FAIL_PUTS_ERROR(params, "Failed to write entire dataset");
        ...
        if (H5Dread(dset_id, H5T_NATIVE_INT, mspace_id_all, fspace_id, H5P_DEFAULT, buf_point) < 0)
            TESTFRAME_FAIL_PUTS_ERROR(params, "Failed to read points from dataset to all memory buffer");

        /* Verify data */
        for (i = 0; i < DATASET_IO_POINT_NPOINTS; i++)
            if (buf_point[i] != file_state[points[2 * i]][points[2 * i + 1]])
                TESTFRAME_FAIL_PUTS_ERROR(params, "Incorrect data read from points to all memory buffer");
        ...
        if (H5Dwrite(dset_id, H5T_NATIVE_INT, mspace_id_all, fspace_id, H5P_DEFAULT, buf_point) < 0)
            TESTFRAME_FAIL_PUTS_ERROR(params, "Failed to write points to dataset from all memory buffer");
        ...
        if (H5Dread(dset_id, H5T_NATIVE_INT, H5S_ALL, H5S_ALL, H5P_DEFAULT, buf_all) < 0)
            TESTFRAME_FAIL_PUTS_ERROR(params, "Failed to read entire dataset");

        /* Verify data */
        for (i = 0; i < DATASET_IO_POINT_DIM_0; i++)
            for (j = 0; j < DATASET_IO_POINT_DIM_1; j++)
                if (buf_all[i][j] != file_state[i][j])
                    TESTFRAME_FAIL_PUTS_ERROR(
                        params, "Incorrect data found after writing from all memory buffer to points");

        if (do_chunk) {
            SUBTEST_BEGIN(params,
                          "point selection I/O with points in memory and file (same shape) with chunking");
        }
        else {
        ...
        if (H5Dread(dset_id, H5T_NATIVE_INT, fspace_id, fspace_id, H5P_DEFAULT, buf_all) < 0)
            TESTFRAME_FAIL_PUTS_ERROR(params,
                                      "Failed to read points from dataset to points in memory buffer");
        ...
        for (i = 0; i < DATASET_IO_POINT_DIM_0; i++)
            for (j = 0; j < DATASET_IO_POINT_DIM_1; j++)
                if (buf_all[i][j] != erbuf[i][j])
                    TESTFRAME_FAIL_PUTS_ERROR(
                        params, "Incorrect data found read from points in file to points in memory");
        ...
        if (H5Dwrite(dset_id, H5T_NATIVE_INT, fspace_id, fspace_id, H5P_DEFAULT, buf_all) < 0)
            TESTFRAME_FAIL_PUTS_ERROR(params, "Failed to write from in memory to points in dataset");
        ...
        if (do_chunk) {
            SUBTEST_BEGIN(
                params, "point selection I/O with points in memory and file (different shape) with chunking");
        }
        else {
        ...
        for (i = 0; i < DATASET_IO_POINT_DIM_0; i++)
            for (j = 0; j < DATASET_IO_POINT_DIM_1; j++)
                if (buf_all[i][j] != erbuf[i][j])
                    TESTFRAME_FAIL_PUTS_ERROR(
                        params, "Incorrect data found after reading from points in file to points in memory");
        ...
        if (H5Dwrite(dset_id, H5T_NATIVE_INT, mspace_id_full, fspace_id, H5P_DEFAULT, buf_all) < 0)
            TESTFRAME_FAIL_PUTS_ERROR(params, "Failed to write from points in memory to points in dataset");
        ...
        if (do_chunk) {
            SUBTEST_BEGIN(params,
                          "point selection I/O with hyperslab in memory and points in file with chunking");
        }
        else {
        ...
        if (H5Dread(dset_id, H5T_NATIVE_INT, mspace_id_full, fspace_id, H5P_DEFAULT, buf_all) < 0)
            TESTFRAME_FAIL_PUTS_ERROR(params,
                                      "Failed to read points from dataset to hyperslab in memory buffer");
        ...
        if (H5Dwrite(dset_id, H5T_NATIVE_INT, mspace_id_full, fspace_id, H5P_DEFAULT, buf_all) < 0)
            TESTFRAME_FAIL_PUTS_ERROR(params,
                                      "Failed to write from hyperslab in memory to points in dataset");
        ...
        for (i = 0; i < DATASET_IO_POINT_DIM_0; i++)
            for (j = 0; j < DATASET_IO_POINT_DIM_1; j++)
                if (buf_all[i][j] != file_state[i][j])
                    TESTFRAME_FAIL_PUTS_ERROR(
                        params, "Incorrect data found after writing from hyperslab in memory to "
                                "points in dataset");

        if (do_chunk) {
            SUBTEST_BEGIN(params,
                          "point selection I/O with points in memory and hyperslab in file with chunking");
        }
        else {
        ...
        if (H5Dread(dset_id, H5T_NATIVE_INT, mspace_id_full, fspace_id, H5P_DEFAULT, buf_all) < 0)
            TESTFRAME_FAIL_PUTS_ERROR(params,
                                      "Failed to read hyperslab from dataset to points in memory buffer");
        ...
        if (H5Dwrite(dset_id, H5T_NATIVE_INT, mspace_id_full, fspace_id, H5P_DEFAULT, buf_all) < 0)
            TESTFRAME_FAIL_PUTS_ERROR(params,
                                      "Failed to write from points in memory to hyperslab in dataset");
 ...
 */
static herr_t
test_read_dataset_invalid_params(TestParams_t *params)
{
    ...
    SUBTEST_BEGIN(params, "H5Dread with an invalid dataset ID")
    {
        H5E_BEGIN_TRY
        {
            err_ret = H5Dread(H5I_INVALID_HID, DATASET_READ_INVALID_PARAMS_TEST_DSET_DTYPE, H5S_ALL, H5S_ALL,
    ...
    SUBTEST_BEGIN(params, "H5Dread with an invalid memory dataspace")
    {
        H5E_BEGIN_TRY
        {
            err_ret = H5Dread(dset_id, DATASET_READ_INVALID_PARAMS_TEST_DSET_DTYPE, H5I_INVALID_HID, H5S_ALL,
                              H5P_DEFAULT, read_buf);
        }
        H5E_END_TRY
    ...
    SUBTEST_BEGIN(params, "H5Dread with an invalid file dataspace")
    {
        H5E_BEGIN_TRY
        {
            err_ret = H5Dread(dset_id, DATASET_READ_INVALID_PARAMS_TEST_DSET_DTYPE, H5S_ALL, H5I_INVALID_HID,
                              H5P_DEFAULT, read_buf);
        }
        H5E_END_TRY
 ...
 */
static herr_t
test_write_dataset_small_all(TestParams_t *params)
{
 ...
 */
static herr_t
test_write_dataset_small_hyperslab(TestParams_t *params)
{
 ...
 */
static herr_t
test_write_dataset_small_point_selection(TestParams_t *params)
{
 ...
 */
static herr_t
test_write_dataset_data_verification(TestParams_t *params)
{
    hssize_t space_npoints;
    ...
    SUBTEST_BEGIN(params, "H5Dwrite using point selection then H5Dread")
    {
        ...
        if (H5Sselect_elements(fspace_id, H5S_SELECT_SET, DATASET_DATA_VERIFY_WRITE_TEST_NUM_POINTS, points) <
            0) {
 ...
 */
static herr_t
test_write_multi_dataset_small_all(TestParams_t *params)
{
    hssize_t    space_npoints;
    hsize_t     dims[DATASET_SMALL_WRITE_TEST_ALL_DSET_SPACE_RANK] = {10, 5, 3};
    size_t      i;
 ...
 */
static herr_t
test_write_multi_dataset_small_hyperslab(TestParams_t *params)
{
    hsize_t     start[DATASET_SMALL_WRITE_TEST_HYPERSLAB_DSET_SPACE_RANK];
    hsize_t     stride[DATASET_SMALL_WRITE_TEST_HYPERSLAB_DSET_SPACE_RANK];
    hsize_t     count[DATASET_SMALL_WRITE_TEST_HYPERSLAB_DSET_SPACE_RANK];
 ...
 */
static herr_t
test_write_multi_dataset_small_point_selection(TestParams_t *params)
{
    hsize_t     points[DATASET_SMALL_WRITE_TEST_POINT_SELECTION_NUM_POINTS *
                   DATASET_SMALL_WRITE_TEST_POINT_SELECTION_DSET_SPACE_RANK];
    hsize_t     dims[DATASET_SMALL_WRITE_TEST_POINT_SELECTION_DSET_SPACE_RANK] = {10, 10, 10};
 ...
 */
static herr_t
test_write_multi_dataset_data_verification(TestParams_t *params)
{
 ...
 */
static herr_t
test_write_dataset_invalid_params(TestParams_t *params)
{
    hssize_t space_npoints;
 ...
 */
static herr_t
test_dataset_string_encodings(TestParams_t *params)
{
    hid_t   file_id                             = H5I_INVALID_HID;
    hid_t   container_group                     = H5I_INVALID_HID;
 ...
 */
static herr_t
test_dataset_builtin_type_conversion(TestParams_t *params)
{
    hssize_t    space_npoints;
    ...
    {
        if (H5Dwrite(dset_id, DATASET_DATA_BUILTIN_CONVERSION_TEST_MEM_DTYPE, H5S_ALL, H5S_ALL, H5P_DEFAULT,
                     data) < 0) {
            printf("    couldn't write to dataset '%s'\n", DATASET_DATA_BUILTIN_CONVERSION_TEST_DSET_NAME);
            TESTFRAME_TEST_ERROR(params);
        }
        ...
        if (NULL ==
            (data = malloc((hsize_t)space_npoints * DATASET_DATA_BUILTIN_CONVERSION_TEST_MEM_DTYPESIZE))) {
            printf("    couldn't allocate buffer for dataset read\n");
            TESTFRAME_TEST_ERROR(params);
        }

        if (H5Dread(dset_id, DATASET_DATA_BUILTIN_CONVERSION_TEST_MEM_DTYPE, H5S_ALL, H5S_ALL, H5P_DEFAULT,
                    data) < 0) {
            printf("    couldn't read from dataset '%s'\n", DATASET_DATA_BUILTIN_CONVERSION_TEST_DSET_NAME);
            TESTFRAME_TEST_ERROR(params);
        }
...
static herr_t
test_dataset_real_to_int_conversion(TestParams_t *params)
{
    hssize_t space_npoints;
    ...
    SUBTEST_BEGIN(params, "write then read int from real dataset with hyperslab selection")
    {
        ...
        if (H5Dwrite(dset_id, DATASET_DATA_REAL_CONVERSION_TEST_INT_TYPE, mspace_id, fspace_id, H5P_DEFAULT,
                     write_buf) < 0) {
            printf("    couldn't write to dataset '%s'\n", DATASET_DATA_REAL_CONVERSION_TEST_DSET_NAME);
            TESTFRAME_TEST_ERROR(params);
        }
        ...
        if (NULL ==
            (read_buf = malloc((hsize_t)space_npoints * DATASET_DATA_REAL_CONVERSION_TEST_INT_DTYPESIZE))) {
            printf("    couldn't allocate buffer for dataset read\n");
            TESTFRAME_TEST_ERROR(params);
        }
    ...
    {
        data_size =
            DATASET_DATA_REAL_CONVERSION_TEST_NUM_POINTS * DATASET_DATA_REAL_CONVERSION_TEST_INT_DTYPESIZE;
...
static herr_t
test_dataset_compound_partial_io(TestParams_t *params)
{
...
static herr_t
test_dataset_vlen_io(TestParams_t *params)
{
    hid_t file_id         = H5I_INVALID_HID;
    hid_t container_group = H5I_INVALID_HID;
    hid_t space_id        = H5I_INVALID_HID;
 ...
 */
static herr_t
test_dataset_set_extent_chunked_unlimited(TestParams_t *params)
{
 ...
 */
static herr_t
test_dataset_set_extent_chunked_fixed(TestParams_t *params)
{
 ...
 */
static herr_t
test_dataset_set_extent_data(TestParams_t *params)
{
 ...
 */
static herr_t
test_dataset_set_extent_double_handles(TestParams_t *params)
{
 ...
 */
static herr_t
test_dataset_set_extent_invalid_params(TestParams_t *params)
{
 ...
 */
static herr_t
test_flush_dataset(TestParams_t H5_ATTR_UNUSED *params)
{
    return SKIP;
}
 ...
 */
static herr_t
test_flush_dataset_invalid_params(TestParams_t H5_ATTR_UNUSED *params)
{
    return SKIP;
}
 ...
 */
static herr_t
test_refresh_dataset(TestParams_t H5_ATTR_UNUSED *params)
{
    return SKIP;
}
 ...
 */
static herr_t
test_refresh_dataset_invalid_params(TestParams_t H5_ATTR_UNUSED *params)
{
    return SKIP;
}
 ...
 */
static herr_t
test_create_single_chunk_dataset(TestParams_t *params)
{
 ...
 */
static herr_t
test_write_single_chunk_dataset(TestParams_t *params)
{
    hssize_t space_npoints;
 ...
 */
static herr_t
test_create_multi_chunk_dataset(TestParams_t *params)
{
 ...
 */
static herr_t
test_write_multi_chunk_dataset_same_shape_read(TestParams_t *params)
{
 ...
 */
static herr_t
test_write_multi_chunk_dataset_diff_shape_read(TestParams_t *params)
{
 ...
 */
static herr_t
test_overwrite_multi_chunk_dataset_same_shape_read(TestParams_t *params)
{
 ...
 */
static herr_t
test_overwrite_multi_chunk_dataset_diff_shape_read(TestParams_t *params)
{
...
static herr_t
test_read_partial_chunk_all_selection(TestParams_t *params)
{
...
static herr_t
test_read_partial_chunk_hyperslab_selection(TestParams_t *params)
{
...
/* #define FIXED_CHUNK_DIMSIZE 10 */
static herr_t
test_read_partial_chunk_point_selection(TestParams_t H5_ATTR_UNUSED *params)
{
    return SKIP;
}
/* #undef FIXED_DIMSIZE */
 ...
 */
static herr_t
test_get_vlen_buf_size(TestParams_t *params)
{
