...
static herr_t test_create_hard_link_same_loc(TestParams_t *params);
static herr_t test_create_hard_link_invalid_params(TestParams_t *params);
static herr_t test_create_soft_link_existing_relative(TestParams_t *params);
static herr_t test_create_soft_link_existing_absolute(TestParams_t *params);
static herr_t test_create_soft_link_dangling_relative(TestParams_t *params);
static herr_t test_create_soft_link_dangling_absolute(TestParams_t *params);
static herr_t test_create_soft_link_long_name(TestParams_t *params);
static herr_t test_create_soft_link_many(TestParams_t *params);
static herr_t test_create_soft_link_invalid_params(TestParams_t *params);
static herr_t test_create_external_link(TestParams_t *params);
static herr_t test_create_external_link_dangling(TestParams_t *params);
static herr_t test_create_external_link_multi(TestParams_t *params);
static herr_t test_create_external_link_ping_pong(TestParams_t *params);
static herr_t test_create_external_link_invalid_params(TestParams_t *params);
static herr_t test_create_user_defined_link(TestParams_t *params);
static herr_t test_create_user_defined_link_invalid_params(TestParams_t *params);
static herr_t test_delete_link(TestParams_t *params);
static herr_t test_delete_link_reset_grp_max_crt_order(TestParams_t *params);
static herr_t test_delete_link_invalid_params(TestParams_t *params);
static herr_t test_copy_link(TestParams_t *params);
static herr_t test_copy_links_into_group_with_links(TestParams_t *params);
static herr_t test_copy_link_across_files(TestParams_t *params);
static herr_t test_copy_link_invalid_params(TestParams_t *params);
static herr_t test_move_link(TestParams_t *params);
static herr_t test_move_links_into_group_with_links(TestParams_t *params);
static herr_t test_move_link_across_files(TestParams_t *params);
static herr_t test_move_link_reset_grp_max_crt_order(TestParams_t *params);
static herr_t test_move_link_invalid_params(TestParams_t *params);
static herr_t test_get_link_val(TestParams_t *params);
static herr_t test_get_link_val_invalid_params(TestParams_t *params);
static herr_t test_get_link_info(TestParams_t *params);
static herr_t test_get_link_info_invalid_params(TestParams_t *params);
static herr_t test_get_link_name(TestParams_t *params);
static herr_t test_get_link_name_invalid_params(TestParams_t *params);
static herr_t test_link_iterate_hard_links(TestParams_t *params);
static herr_t test_link_iterate_soft_links(TestParams_t *params);
static herr_t test_link_iterate_external_links(TestParams_t *params);
static herr_t test_link_iterate_ud_links(TestParams_t *params);
static herr_t test_link_iterate_mixed_links(TestParams_t *params);
static herr_t test_link_iterate_invalid_params(TestParams_t *params);
static herr_t test_link_iterate_0_links(TestParams_t *params);
static herr_t test_link_visit_hard_links_no_cycles(TestParams_t *params);
static herr_t test_link_visit_soft_links_no_cycles(TestParams_t *params);
static herr_t test_link_visit_external_links_no_cycles(TestParams_t *params);
static herr_t test_link_visit_ud_links_no_cycles(TestParams_t *params);
static herr_t test_link_visit_mixed_links_no_cycles(TestParams_t *params);
static herr_t test_link_visit_hard_links_cycles(TestParams_t *params);
static herr_t test_link_visit_soft_links_cycles(TestParams_t *params);
static herr_t test_link_visit_external_links_cycles(TestParams_t *params);
static herr_t test_link_visit_ud_links_cycles(TestParams_t *params);
static herr_t test_link_visit_mixed_links_cycles(TestParams_t *params);
static herr_t test_link_visit_invalid_params(TestParams_t *params);
static herr_t test_link_visit_0_links(TestParams_t *params);
 ...
 */
static herr_t
test_create_hard_link(TestParams_t *params)
{
    htri_t link_exists;
 ...
 */
static herr_t
test_create_hard_link_long_name(TestParams_t *params)
{
    htri_t link_exists;
    hid_t  file_id = H5I_INVALID_HID;
    char   vol_name[5];
 ...
 */
static herr_t
test_create_hard_link_many(TestParams_t *params)
{
    htri_t link_exists;
    hid_t  file_id         = H5I_INVALID_HID;
 ...
 */
static herr_t
test_create_hard_link_same_loc(TestParams_t *params)
{
    htri_t link_exists;
    hid_t  file_id         = H5I_INVALID_HID;
    hid_t  container_group = H5I_INVALID_HID, group_id = H5I_INVALID_HID;
    ...
    SUBTEST_BEGIN(params, "usage of H5L_SAME_LOC for first parameter of H5Lcreate_hard")
    {
    ...
    SUBTEST_BEGIN(params, "usage of H5L_SAME_LOC for third parameter of H5Lcreate_hard")
    {
 ...
 */
static herr_t
test_create_hard_link_invalid_params(TestParams_t *params)
{
    herr_t err_ret = -1;
    htri_t link_exists;
    hid_t  file_id         = H5I_INVALID_HID;
    ...
    if (prefix_test_filename(params, test_path_prefix, EXTERNAL_LINK_TEST_FILE_NAME, &ext_link_filename) <
        0) {
    ...
    SUBTEST_BEGIN(params, "H5Lcreate_hard with an invalid cur_loc_id")
    {
        H5E_BEGIN_TRY
        {
            err_ret = H5Lcreate_hard(H5I_INVALID_HID, "/", group_id, HARD_LINK_INVALID_PARAMS_TEST_LINK_NAME,
    ...
    SUBTEST_BEGIN(params, "H5Lcreate_hard with an invalid cur_name")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Lcreate_hard with an invalid new_loc_id")
    {
        H5E_BEGIN_TRY
        {
            err_ret = H5Lcreate_hard(file_id, "/", H5I_INVALID_HID, HARD_LINK_INVALID_PARAMS_TEST_LINK_NAME,
                                     H5P_DEFAULT, H5P_DEFAULT);
        }
        H5E_END_TRY
    ...
    SUBTEST_BEGIN(params, "H5Lcreate_hard with an invalid new_name")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Lcreate_hard with an invalid LCPL")
    {
        H5E_BEGIN_TRY
        {
            err_ret = H5Lcreate_hard(file_id, "/", group_id, HARD_LINK_INVALID_PARAMS_TEST_LINK_NAME,
    ...
    SUBTEST_BEGIN(params, "H5Lcreate_hard with an invalid LAPL")
    {
        H5E_BEGIN_TRY
        {
            err_ret = H5Lcreate_hard(file_id, "/", group_id, HARD_LINK_INVALID_PARAMS_TEST_LINK_NAME,
    ...
    SUBTEST_BEGIN(params, "H5Lcreate_hard with the invalid same location")
    {
        H5E_BEGIN_TRY
        {
            err_ret = H5Lcreate_hard(H5L_SAME_LOC, "/", H5L_SAME_LOC, HARD_LINK_INVALID_PARAMS_TEST_LINK_NAME,
                                     H5P_DEFAULT, H5P_DEFAULT);
        }
        H5E_END_TRY
    ...
    SUBTEST_BEGIN(params, "H5Lcreate_hard across files")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "invalid link existence after previous invalid H5Lcreate_hard calls")
    {
 ...
 */
static herr_t
test_create_soft_link_existing_relative(TestParams_t *params)
{
    htri_t link_exists;
    hid_t  file_id         = H5I_INVALID_HID;
    hid_t  container_group = H5I_INVALID_HID, group_id = H5I_INVALID_HID;
 ...
 */
static herr_t
test_create_soft_link_existing_absolute(TestParams_t *params)
{
    htri_t link_exists;
    hid_t  file_id         = H5I_INVALID_HID;
 ...
 */
static herr_t
test_create_soft_link_dangling_relative(TestParams_t *params)
{
    htri_t link_exists;
    hid_t  file_id         = H5I_INVALID_HID;
    hid_t  container_group = H5I_INVALID_HID, group_id = H5I_INVALID_HID;
 ...
 */
static herr_t
test_create_soft_link_dangling_absolute(TestParams_t *params)
{
    htri_t link_exists;
    hid_t  file_id         = H5I_INVALID_HID;
    hid_t  container_group = H5I_INVALID_HID, group_id = H5I_INVALID_HID;
 ...
 */
static herr_t
test_create_soft_link_long_name(TestParams_t *params)
{
    htri_t link_exists;
    hid_t  file_id = H5I_INVALID_HID;
    char   vol_name[5];
 ...
 */
static herr_t
test_create_soft_link_many(TestParams_t *params)
{
 ...
 */
static herr_t
test_create_soft_link_invalid_params(TestParams_t *params)
{
    herr_t err_ret = -1;
    htri_t link_exists;
    hid_t  file_id         = H5I_INVALID_HID;
    ...
    SUBTEST_BEGIN(params, "H5Lcreate_soft with an invalid link target")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Lcreate_soft with an invalid link_loc_id")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Lcreate_soft with an invalid link name")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Lcreate_soft with an invalid LCPL")
    {
        H5E_BEGIN_TRY
        {
            err_ret = H5Lcreate_soft("/", group_id, SOFT_LINK_INVALID_PARAMS_TEST_LINK_NAME, H5I_INVALID_HID,
                                     H5P_DEFAULT);
        }
        H5E_END_TRY
    ...
    SUBTEST_BEGIN(params, "H5Lcreate_soft with an invalid LAPL")
    {
        H5E_BEGIN_TRY
        {
            err_ret = H5Lcreate_soft("/", group_id, SOFT_LINK_INVALID_PARAMS_TEST_LINK_NAME, H5P_DEFAULT,
    ...
    SUBTEST_BEGIN(params, "invalid link existence after previous invalid H5Lcreate_soft calls")
    {
        /* Verify the link hasn't been created */
 ...
 */
static herr_t
test_create_external_link(TestParams_t *params)
{
    htri_t link_exists;
    hid_t  file_id         = H5I_INVALID_HID;
    hid_t  container_group = H5I_INVALID_HID, group_id = H5I_INVALID_HID;
 ...
 */
static herr_t
test_create_external_link_dangling(TestParams_t *params)
{
    htri_t link_exists;
 ...
 */
static herr_t
test_create_external_link_multi(TestParams_t *params)
{
    hid_t file_id         = H5I_INVALID_HID;
    hid_t container_group = H5I_INVALID_HID, group_id = H5I_INVALID_HID;
    ...
    SUBTEST_BEGIN(params, "Create the first external file to be pointed to")
    {
        if (prefix_test_filename(params, test_path_prefix, EXTERNAL_LINK_TEST_FILE_NAME,
                                 &ext_link_filename1) < 0) {
            printf("    couldn't create external link filename\n");
            TESTFRAME_TEST_ERROR(params);
        }
    ...
    SUBTEST_BEGIN(params, "Create the second external file to be pointed to")
    {
        if (prefix_test_filename(params, test_path_prefix, EXTERNAL_LINK_TEST_FILE_NAME2,
                                 &ext_link_filename2) < 0) {
            printf("    couldn't create external link filename\n");
            TESTFRAME_TEST_ERROR(params);
        }
    ...
    SUBTEST_BEGIN(params, "Create the third external file to be pointed to")
    {
        if (prefix_test_filename(params, test_path_prefix, EXTERNAL_LINK_TEST_FILE_NAME3,
                                 &ext_link_filename3) < 0) {
            printf("    couldn't create external link filename\n");
            TESTFRAME_TEST_ERROR(params);
        }
    ...
    SUBTEST_BEGIN(params, "Open the file and create the final external link")
    {
        if ((file_id = H5Fopen(H5_API_TEST_FILENAME(params), H5F_ACC_RDWR, H5P_DEFAULT)) < 0) {
            printf("    couldn't open file '%s'\n", H5_API_TEST_FILENAME(params));
            TESTFRAME_TEST_ERROR(params);
        ...
        if ((group_id = H5Gcreate2(container_group, EXTERNAL_LINK_TEST_MULTI_NAME, H5P_DEFAULT, H5P_DEFAULT,
                                   H5P_DEFAULT)) < 0) {
            printf("    couldn't create container subgroup '%s'\n", EXTERNAL_LINK_TEST_MULTI_NAME);
            TESTFRAME_TEST_ERROR(params);
        }

        if (H5Lcreate_external(ext_link_filename3, "/G/H/I", group_id, "ext_link", H5P_DEFAULT, H5P_DEFAULT) <
            0) {
    ...
    SUBTEST_BEGIN(params, "Check the group being created through the external link")
    {
 ...
 */
static herr_t
test_create_external_link_ping_pong(TestParams_t *params)
{
    hid_t file_id            = H5I_INVALID_HID;
    hid_t group_id           = H5I_INVALID_HID;
    ...
    if (prefix_test_filename(params, test_path_prefix, EXTERNAL_LINK_TEST_PING_PONG_NAME1,
                             &ext_link_filename1) < 0) {
        printf("    couldn't create external link filename\n");
        goto error;
    }

    if (prefix_test_filename(params, test_path_prefix, EXTERNAL_LINK_TEST_PING_PONG_NAME2,
                             &ext_link_filename2) < 0) {
        printf("    couldn't create external link filename\n");
        goto error;
    }

    SUBTEST_BEGIN(params, "Create the first external file")
    {
    ...
    SUBTEST_BEGIN(params, "Create the second external file")
    {
    ...
    SUBTEST_BEGIN(params, "Open the first file to verify the object being pointed to")
    {
        if ((file_id = H5Fopen(ext_link_filename1, H5F_ACC_RDWR, H5P_DEFAULT)) < 0) {
            printf("    couldn't open file '%s'\n", ext_link_filename1);
            TESTFRAME_TEST_ERROR(params);
    ...
    SUBTEST_BEGIN(params, "Open the first file to verify the object being created")
    {
        ...
        for (size_t i = 1; i < EXTERNAL_LINK_TEST_PING_PONG_NUM_LINKS + 1 && !valid_name_matched; i++) {
            ...
            snprintf(name_possibility, H5_API_TEST_FILENAME_MAX_LENGTH, "%s%zu%s", "/link", i, "/new_group");
 ...
 */
static herr_t
test_create_external_link_invalid_params(TestParams_t *params)
{
    herr_t err_ret = -1;
    htri_t link_exists;
    hid_t  file_id         = H5I_INVALID_HID;
    ...
    if (prefix_test_filename(params, test_path_prefix, EXTERNAL_LINK_INVALID_PARAMS_TEST_FILE_NAME,
                             &ext_link_filename) < 0) {
    ...
    SUBTEST_BEGIN(params, "H5Lcreate_external with an invalid file name")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Lcreate_external with an invalid external object name")
    {
        H5E_BEGIN_TRY
        {
            err_ret =
    ...
    SUBTEST_BEGIN(params, "H5Lcreate_external with an invalid link_loc_id")
    {
        H5E_BEGIN_TRY
        {
            err_ret =
    ...
    SUBTEST_BEGIN(params, "H5Lcreate_external with an invalid link name")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Lcreate_external with an invalid LCPL")
    {
        H5E_BEGIN_TRY
        {
            err_ret =
                H5Lcreate_external(ext_link_filename, "/", group_id,
                                   EXTERNAL_LINK_INVALID_PARAMS_TEST_LINK_NAME, H5I_INVALID_HID, H5P_DEFAULT);
        }
        H5E_END_TRY
    ...
    SUBTEST_BEGIN(params, "H5Lcreate_external with an invalid LAPL")
    {
        H5E_BEGIN_TRY
        {
            err_ret =
                H5Lcreate_external(ext_link_filename, "/", group_id,
                                   EXTERNAL_LINK_INVALID_PARAMS_TEST_LINK_NAME, H5P_DEFAULT, H5I_INVALID_HID);
        }
        H5E_END_TRY
    ...
    SUBTEST_BEGIN(params, "invalid link existence after previous invalid H5Lcreate_external calls")
    {
        /* Verify the link hasn't been created */
        if ((link_exists = H5Lexists(group_id, EXTERNAL_LINK_INVALID_PARAMS_TEST_LINK_NAME, H5P_DEFAULT)) <
            0) {
            printf("    couldn't determine if link '%s' exists\n",
                   EXTERNAL_LINK_INVALID_PARAMS_TEST_LINK_NAME);
            TESTFRAME_TEST_ERROR(params);
 ...
 */
static herr_t
test_create_user_defined_link(TestParams_t *params)
{
    ssize_t udata_size;
    htri_t  link_exists;
    hid_t   file_id         = H5I_INVALID_HID;
 ...
 */
static herr_t
test_create_user_defined_link_invalid_params(TestParams_t *params)
{
    ssize_t udata_size;
    htri_t  link_exists;
    herr_t  err_ret         = -1;
    ...
    SUBTEST_BEGIN(params, "H5Lcreate_ud with an invalid link location ID")
    {
        H5E_BEGIN_TRY
        {
            err_ret = H5Lcreate_ud(H5I_INVALID_HID, UD_LINK_INVALID_PARAMS_TEST_LINK_NAME, H5L_TYPE_EXTERNAL,
    ...
    SUBTEST_BEGIN(params, "H5Lcreate_ud with an invalid link name")
    {
        H5E_BEGIN_TRY
        {
            err_ret = H5Lcreate_ud(group_id, NULL, H5L_TYPE_EXTERNAL, udata, (size_t)udata_size, H5P_DEFAULT,
                                   H5P_DEFAULT);
        }
        H5E_END_TRY
        ...
        H5E_BEGIN_TRY
        {
            err_ret = H5Lcreate_ud(group_id, "", H5L_TYPE_EXTERNAL, udata, (size_t)udata_size, H5P_DEFAULT,
                                   H5P_DEFAULT);
        }
        H5E_END_TRY
    ...
    SUBTEST_BEGIN(params, "H5Lcreate_ud with an invalid link type")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Lcreate_ud with an invalid udata pointer")
    {
        H5E_BEGIN_TRY
        {
            err_ret = H5Lcreate_ud(group_id, UD_LINK_INVALID_PARAMS_TEST_LINK_NAME, H5L_TYPE_EXTERNAL, NULL,
                                   (size_t)udata_size, H5P_DEFAULT, H5P_DEFAULT);
        }
        H5E_END_TRY
    ...
    SUBTEST_BEGIN(params, "H5Lcreate_ud with an invalid LCPL")
    {
        H5E_BEGIN_TRY
        {
            err_ret = H5Lcreate_ud(group_id, UD_LINK_INVALID_PARAMS_TEST_LINK_NAME, H5L_TYPE_EXTERNAL, udata,
                                   (size_t)udata_size, H5I_INVALID_HID, H5P_DEFAULT);
        }
        H5E_END_TRY
    ...
    SUBTEST_BEGIN(params, "H5Lcreate_ud with an invalid LAPL")
    {
        H5E_BEGIN_TRY
        {
            err_ret = H5Lcreate_ud(group_id, UD_LINK_INVALID_PARAMS_TEST_LINK_NAME, H5L_TYPE_EXTERNAL, udata,
                                   (size_t)udata_size, H5P_DEFAULT, H5I_INVALID_HID);
        }
        H5E_END_TRY
    ...
    SUBTEST_BEGIN(params, "invalid link existence after previous invalid H5Lcreate_ud calls")
    {
        /* Verify the link hasn't been created */
 ...
 */
static herr_t
test_delete_link(TestParams_t *params)
{
    htri_t link_exists;
    hid_t  file_id = H5I_INVALID_HID, ext_file_id = H5I_INVALID_HID;
    hid_t  container_group = H5I_INVALID_HID, group_id = H5I_INVALID_HID;
    ...
    SUBTEST_BEGIN(params, "H5Ldelete on hard link")
    {
    ...
    SUBTEST_BEGIN(params, "H5Ldelete on nested hard link")
    {
        ...
        if ((nested_grp_id = H5Gcreate2(subgroup_id, LINK_DELETE_TEST_NESTED_GRP_NAME, H5P_DEFAULT, gcpl_id,
                                        H5P_DEFAULT)) < 0) {
            printf("    couldn't create subgroup '%s'\n", LINK_DELETE_TEST_NESTED_GRP_NAME);
            TESTFRAME_TEST_ERROR(params);
        }

        if (H5Lcreate_hard(nested_grp_id, ".", nested_grp_id, LINK_DELETE_TEST_HARD_LINK_NAME, H5P_DEFAULT,
                           H5P_DEFAULT) < 0) {
            printf("    couldn't create first hard link '%s'\n", LINK_DELETE_TEST_HARD_LINK_NAME);
            TESTFRAME_TEST_ERROR(params);
        }
    ...
    SUBTEST_BEGIN(params, "H5Ldelete on soft link")
    {
    ...
    SUBTEST_BEGIN(params, "H5Ldelete on external link")
    {
    ...
    SUBTEST_BEGIN(params, "H5Ldelete on user-defined link")
    {
        /* TODO */
    ...
    SUBTEST_BEGIN(params, "H5Ldelete_by_idx on hard link by creation order in increasing order")
    {
    ...
    SUBTEST_BEGIN(params, "H5Ldelete_by_idx on hard link by creation order in decreasing order")
    {
        if (!(vol_cap_flags_g & H5VL_CAP_FLAG_BY_IDX)) {
            TESTFRAME_SKIPPED(params);
            printf("    by index isn't supported with this VOL connector\n");
    ...
    SUBTEST_BEGIN(params, "H5Ldelete_by_idx on hard link by alphabetical order in increasing order")
    {
        if (!(vol_cap_flags_g & H5VL_CAP_FLAG_BY_IDX)) {
            TESTFRAME_SKIPPED(params);
            printf("    by index isn't supported with this VOL connector\n");
    ...
    SUBTEST_BEGIN(params, "H5Ldelete_by_idx on hard link by alphabetical order in decreasing order")
    {
        if (!(vol_cap_flags_g & H5VL_CAP_FLAG_BY_IDX)) {
            TESTFRAME_SKIPPED(params);
            printf("    by index isn't supported with this VOL connector\n");
    ...
    SUBTEST_BEGIN(params, "H5Ldelete_by_idx on soft link by creation order in increasing order")
    {
        if (!(vol_cap_flags_g & H5VL_CAP_FLAG_BY_IDX)) {
            TESTFRAME_SKIPPED(params);
            printf("    by index isn't supported with this VOL connector\n");
    ...
    SUBTEST_BEGIN(params, "H5Ldelete_by_idx on soft link by creation order in decreasing order")
    {
        if (!(vol_cap_flags_g & H5VL_CAP_FLAG_BY_IDX)) {
            TESTFRAME_SKIPPED(params);
            printf("    by index isn't supported with this VOL connector\n");
    ...
    SUBTEST_BEGIN(params, "H5Ldelete_by_idx on soft link by alphabetical order in increasing order")
    {
        if (!(vol_cap_flags_g & H5VL_CAP_FLAG_BY_IDX)) {
            TESTFRAME_SKIPPED(params);
            printf("    by index isn't supported with this VOL connector\n");
    ...
    SUBTEST_BEGIN(params, "H5Ldelete_by_idx on soft link by alphabetical order in decreasing order")
    {
        if (!(vol_cap_flags_g & H5VL_CAP_FLAG_BY_IDX)) {
            TESTFRAME_SKIPPED(params);
            printf("    by index isn't supported with this VOL connector\n");
    ...
    SUBTEST_BEGIN(params, "H5Ldelete_by_idx on external link by creation order in increasing order")
    {
        if (!(vol_cap_flags_g & H5VL_CAP_FLAG_BY_IDX)) {
            TESTFRAME_SKIPPED(params);
            printf("    by index isn't supported with this VOL connector\n");
    ...
    SUBTEST_BEGIN(params, "H5Ldelete_by_idx on external link by creation order in decreasing order")
    {
        if (!(vol_cap_flags_g & H5VL_CAP_FLAG_BY_IDX)) {
            TESTFRAME_SKIPPED(params);
            printf("    by index isn't supported with this VOL connector\n");
    ...
    SUBTEST_BEGIN(params, "H5Ldelete_by_idx on external link by alphabetical order in increasing order")
    {
        if (!(vol_cap_flags_g & H5VL_CAP_FLAG_BY_IDX)) {
            TESTFRAME_SKIPPED(params);
            printf("    by index isn't supported with this VOL connector\n");
    ...
    SUBTEST_BEGIN(params, "H5Ldelete_by_idx on external link by alphabetical order in decreasing order")
    {
        if (!(vol_cap_flags_g & H5VL_CAP_FLAG_BY_IDX)) {
            TESTFRAME_SKIPPED(params);
            printf("    by index isn't supported with this VOL connector\n");
    ...
    SUBTEST_BEGIN(params, "H5Ldelete_by_idx on user-defined link by creation order in increasing order")
    {
        /* TODO */
    ...
    SUBTEST_BEGIN(params, "H5Ldelete_by_idx on user-defined link by creation order in decreasing order")
    {
        /* TODO */
    ...
    SUBTEST_BEGIN(params, "H5Ldelete_by_idx on user-defined link by alphabetical order in increasing order")
    {
        /* TODO */
    ...
    SUBTEST_BEGIN(params, "H5Ldelete_by_idx on user-defined link by alphabetical order in decreasing order")
    {
        /* TODO */
 ...
 */
static herr_t
test_delete_link_reset_grp_max_crt_order(TestParams_t *params)
{
    H5G_info_t grp_info;
    size_t     i;
    hid_t      file_id         = H5I_INVALID_HID;
    ...
    SUBTEST_BEGIN(params, "H5Ldelete from least-recently created link to most-recently created link")
    {
    ...
    SUBTEST_BEGIN(params, "H5Ldelete from most-recently created link to least-recently created link")
    {
...
static herr_t
test_delete_link_invalid_params(TestParams_t *params)
{
    htri_t link_exists;
    herr_t err_ret         = -1;
    hid_t  file_id         = H5I_INVALID_HID;
    ...
    SUBTEST_BEGIN(params, "H5Ldelete with an invalid location ID")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Ldelete with an invalid link name")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Ldelete with an invalid LAPL")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Ldelete_by_idx with an invalid location ID")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Ldelete_by_idx with an invalid group name")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Ldelete_by_idx with an invalid index type")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Ldelete_by_idx with an invalid iteration ordering")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Ldelete_by_idx with an invalid LAPL")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "valid link existence after previous invalid H5Ldelete(_by_idx) calls")
    {
 ...
 */
static herr_t
test_copy_link(TestParams_t *params)
{
    htri_t link_exists;
    hid_t  file_id = H5I_INVALID_HID, ext_file_id = H5I_INVALID_HID;
    hid_t  container_group = H5I_INVALID_HID, group_id = H5I_INVALID_HID;
    ...
    SUBTEST_BEGIN(params, "H5Lcopy on hard link (copied link's properties not checked)")
    {
        ...
        /* Copy the link */
        if (H5Lcopy(src_grp_id, COPY_LINK_TEST_HARD_LINK_NAME, dst_grp_id, COPY_LINK_TEST_HARD_LINK_COPY_NAME,
                    H5P_DEFAULT, H5P_DEFAULT) < 0) {
    ...
    SUBTEST_BEGIN(params, "H5Lcopy on hard link (copied link's properties checked)")
    {
    ...
    SUBTEST_BEGIN(params, "H5Lcopy on hard link using H5L_SAME_LOC")
    {
        /* Try to copy a hard link */
    ...
    SUBTEST_BEGIN(params, "H5Lcopy on soft link (copied link's properties not checked)")
    {
        /* Try to copy a soft link */
        if (H5Lcreate_soft(COPY_LINK_TEST_SOFT_LINK_TARGET_PATH, src_grp_id, COPY_LINK_TEST_SOFT_LINK_NAME,
                           H5P_DEFAULT, H5P_DEFAULT) < 0) {
        ...
        /* Copy the link */
        if (H5Lcopy(src_grp_id, COPY_LINK_TEST_SOFT_LINK_NAME, dst_grp_id, COPY_LINK_TEST_SOFT_LINK_COPY_NAME,
                    H5P_DEFAULT, H5P_DEFAULT) < 0) {
    ...
    SUBTEST_BEGIN(params, "H5Lcopy on soft link (copied link's properties checked)")
    {
        H5L_info2_t orig_info, new_info;
    ...
    SUBTEST_BEGIN(params, "H5Lcopy on soft link using H5L_SAME_LOC")
    {
        /* Try to copy a soft link */
        if (H5Lcreate_soft(COPY_LINK_TEST_SOFT_LINK_TARGET_PATH, src_grp_id, COPY_LINK_TEST_SOFT_LINK_NAME3,
                           H5P_DEFAULT, H5P_DEFAULT) < 0) {
    ...
    SUBTEST_BEGIN(params, "H5Lcopy on external link (copied link's properties not checked)")
    {
    ...
    SUBTEST_BEGIN(params, "H5Lcopy on external link (copied link's properties checked)")
    {
        H5L_info2_t orig_info, new_info;
        ...
        /* Retrieve the new link's info */
        if (H5Lget_info2(dst_grp_id, COPY_LINK_TEST_EXTERNAL_LINK_COPY_NAME2, &new_info, H5P_DEFAULT) < 0) {
            printf("    couldn't retrieve info for link '%s'\n", COPY_LINK_TEST_EXTERNAL_LINK_COPY_NAME2);
            TESTFRAME_TEST_ERROR(params);
        }
    ...
    SUBTEST_BEGIN(params, "H5Lcopy on external link using H5L_SAME_LOC")
    {
        /* Try to copy an external link */
        ...
        /* Verify the links don't currently exist in the target group */
        if ((link_exists = H5Lexists(src_grp_id, COPY_LINK_TEST_EXTERNAL_LINK_SAME_LOC_NAME, H5P_DEFAULT)) <
            0) {
            printf("    couldn't determine if external link '%s' exists\n",
        ...
        if ((link_exists = H5Lexists(src_grp_id, COPY_LINK_TEST_EXTERNAL_LINK_SAME_LOC_NAME2, H5P_DEFAULT)) <
            0) {
            printf("    couldn't determine if external link '%s' exists\n",
    ...
    SUBTEST_BEGIN(params, "H5Lcopy on user-defined link (copied link's properties not checked)")
    {
        /* TODO */
    ...
    SUBTEST_BEGIN(params, "H5Lcopy on user-defined link (copied link's properties checked)")
    {
        /* TODO */
    ...
    SUBTEST_BEGIN(params, "H5Lcopy on user-defined link using H5L_SAME_LOC")
    {
        /* TODO */
 ...
 */
static herr_t
test_copy_links_into_group_with_links(TestParams_t H5_ATTR_UNUSED *params)
{
    return SKIP;
}
 ...
 */
static herr_t
test_copy_link_across_files(TestParams_t H5_ATTR_UNUSED *params)
{
    /* TODO */
 ...
 */
static herr_t
test_copy_link_invalid_params(TestParams_t *params)
{
    herr_t err_ret = -1;
    htri_t link_exists;
    hid_t  file_id         = H5I_INVALID_HID;
    ...
    SUBTEST_BEGIN(params, "H5Lcopy with an invalid source location ID")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Lcopy with an invalid source name")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Lcopy with an invalid destination location ID")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Lcopy with an invalid destination name")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Lcopy with an invalid LCPL")
    {
        H5E_BEGIN_TRY
        {
            err_ret =
    ...
    SUBTEST_BEGIN(params, "H5Lcopy with an invalid LAPL")
    {
        H5E_BEGIN_TRY
        {
            err_ret =
    ...
    SUBTEST_BEGIN(params, "H5Lcopy with an invalid same location")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Lcopy invalid across files")
    {
        H5E_BEGIN_TRY
        {
 ...
 */
static herr_t
test_move_link(TestParams_t *params)
{
    htri_t link_exists;
    hid_t  file_id         = H5I_INVALID_HID;
    hid_t  container_group = H5I_INVALID_HID, group_id = H5I_INVALID_HID;
    ...
    SUBTEST_BEGIN(params, "H5Lmove on hard link (moved link's properties not checked)")
    {
    ...
    SUBTEST_BEGIN(params, "H5Lmove on hard link (moved link's properties checked)")
    {
        H5L_info2_t orig_info, new_info;
        int         cmp_value;
        ...
        if (vol_cap_flags_g & H5VL_CAP_FLAG_CREATION_ORDER) {
            if (new_info.corder_valid != orig_info.corder_valid) {
                printf("    moved link's 'corder_valid' field doesn't match original link's 'corder_valid' "
                       "field\n");
                TESTFRAME_TEST_ERROR(params);
            }
    ...
    SUBTEST_BEGIN(params, "H5Lmove on hard link using H5L_SAME_LOC")
    {
        /* Try to move a hard link */
    ...
    SUBTEST_BEGIN(params, "H5Lmove to rename hard link without moving it")
    {
    ...
    SUBTEST_BEGIN(params, "H5Lmove on soft link (moved link's properties not checked)")
    {
        /* Try to move a soft link */
        if (H5Lcreate_soft(MOVE_LINK_TEST_SOFT_LINK_TARGET_PATH, src_grp_id, MOVE_LINK_TEST_SOFT_LINK_NAME,
                           H5P_DEFAULT, H5P_DEFAULT) < 0) {
    ...
    SUBTEST_BEGIN(params, "H5Lmove on soft link (moved link's properties checked)")
    {
        H5L_info2_t orig_info, new_info;
    ...
    SUBTEST_BEGIN(params, "H5Lmove on soft link using H5L_SAME_LOC")
    {
        /* Try to move a soft link */
        if (H5Lcreate_soft(MOVE_LINK_TEST_SOFT_LINK_TARGET_PATH, src_grp_id, MOVE_LINK_TEST_SOFT_LINK_NAME3,
                           H5P_DEFAULT, H5P_DEFAULT) < 0) {
    ...
    SUBTEST_BEGIN(params, "H5Lmove to rename soft link without moving it")
    {
    ...
    SUBTEST_BEGIN(params, "H5Lmove on external link (moved link's properties not checked)")
    {
    ...
    SUBTEST_BEGIN(params, "H5Lmove on external link (moved link's properties checked)")
    {
        H5L_info2_t orig_info, new_info;
        const char *orig_filename, *new_filename;
        const char *orig_objname, *new_objname;
    ...
    SUBTEST_BEGIN(params, "H5Lmove on external link using H5L_SAME_LOC")
    {
        /* Try to move an external link */
    ...
    SUBTEST_BEGIN(params, "H5Lmove to rename external link without moving it")
    {
        /* Try to move an external link */
    ...
    SUBTEST_BEGIN(params, "H5Lmove on user-defined link (moved link's properties not checked)")
    {
        /* TODO */
    ...
    SUBTEST_BEGIN(params, "H5Lmove on user-defined link (moved link's properties checked)")
    {
        /* TODO */
    ...
    SUBTEST_BEGIN(params, "H5Lmove on user-defined link using H5L_SAME_LOC")
    {
        /* TODO */
    ...
    SUBTEST_BEGIN(params, "H5Lmove to rename user-defined link without moving it")
    {
        /* TODO */
 ...
 */
static herr_t
test_move_links_into_group_with_links(TestParams_t *params)
{
 ...
 */
static herr_t
test_move_link_across_files(TestParams_t H5_ATTR_UNUSED *params)
{
    /* TODO */
 ...
 */
static herr_t
test_move_link_reset_grp_max_crt_order(TestParams_t *params)
{
    H5G_info_t grp_info;
    size_t     i;
    hid_t      file_id         = H5I_INVALID_HID;
 ...
 */
static herr_t
test_move_link_invalid_params(TestParams_t *params)
{
    htri_t link_exists;
    herr_t err_ret         = -1;
    hid_t  file_id         = H5I_INVALID_HID;
    ...
    SUBTEST_BEGIN(params, "H5Lmove with an invalid source location ID")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Lmove with an invalid source name")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Lmove with an invalid destination location ID")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Lmove with an invalid destination name")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Lmove with an invalid LCPL")
    {
        H5E_BEGIN_TRY
        {
            err_ret = H5Lmove(src_grp_id, MOVE_LINK_INVALID_PARAMS_TEST_HARD_LINK_NAME, dst_grp_id,
    ...
    SUBTEST_BEGIN(params, "H5Lmove with an invalid LAPL")
    {
        H5E_BEGIN_TRY
        {
            err_ret = H5Lmove(src_grp_id, MOVE_LINK_INVALID_PARAMS_TEST_HARD_LINK_NAME, dst_grp_id,
    ...
    SUBTEST_BEGIN(params, "valid link existence in original group after previous invalid H5Lmove calls")
    {
    ...
    SUBTEST_BEGIN(params, "H5Lmove with an invalid same location")
    {
    ...
    SUBTEST_BEGIN(params, "H5Lmove into another file")
    {
 ...
 */
static herr_t
test_get_link_val(TestParams_t *params)
{
    H5L_info2_t link_info;
    ...
    SUBTEST_BEGIN(params, "H5Lget_val on soft link")
    {
    ...
    SUBTEST_BEGIN(params, "H5Lget_val on external link")
    {
        ...
        if (H5Lcreate_external(ext_link_filename, ext_obj_name, subgroup_id, GET_LINK_VAL_TEST_EXT_LINK_NAME,
                               H5P_DEFAULT, H5P_DEFAULT) < 0) {
    ...
    SUBTEST_BEGIN(params, "H5Lget_val on user-defined link")
    {
        /* TODO */
    ...
    SUBTEST_BEGIN(params, "H5Lget_val_by_idx on soft link by creation order in increasing order")
    {
    ...
    SUBTEST_BEGIN(params, "H5Lget_val_by_idx on soft link by creation order in decreasing order")
    {
        const char *link_target_a = "/" LINK_TEST_GROUP_NAME "/" GET_LINK_VAL_TEST_SUBGROUP_NAME
    ...
    SUBTEST_BEGIN(params, "H5Lget_val_by_idx on soft link by alphabetical order in increasing order")
    {
        const char *link_target_a = "/" LINK_TEST_GROUP_NAME "/" GET_LINK_VAL_TEST_SUBGROUP_NAME
        ...
        /* Retrieve the info and value of each link in turn */
        memset(&link_info, 0, sizeof(link_info));
        if (H5Lget_info_by_idx2(subgroup_id, ".", H5_INDEX_NAME, H5_ITER_INC, 0, &link_info, H5P_DEFAULT) <
            0) {
            printf("    failed to retrieve soft link's info at index %d\n", 0);
            TESTFRAME_TEST_ERROR(params);
        }
        ...
        memset(&link_info, 0, sizeof(link_info));
        if (H5Lget_info_by_idx2(subgroup_id, ".", H5_INDEX_NAME, H5_ITER_INC, 1, &link_info, H5P_DEFAULT) <
            0) {
            printf("    failed to retrieve soft link's info at index %d\n", 1);
            TESTFRAME_TEST_ERROR(params);
        }
        ...
        memset(&link_info, 0, sizeof(link_info));
        if (H5Lget_info_by_idx2(subgroup_id, ".", H5_INDEX_NAME, H5_ITER_INC, 2, &link_info, H5P_DEFAULT) <
            0) {
            printf("    failed to retrieve soft link's info at index %d\n", 2);
            TESTFRAME_TEST_ERROR(params);
        }
    ...
    SUBTEST_BEGIN(params, "H5Lget_val_by_idx on soft link by alphabetical order in decreasing order")
    {
        const char *link_target_a = "/" LINK_TEST_GROUP_NAME "/" GET_LINK_VAL_TEST_SUBGROUP_NAME
        ...
        /* Retrieve the info and value of each link in turn */
        memset(&link_info, 0, sizeof(link_info));
        if (H5Lget_info_by_idx2(subgroup_id, ".", H5_INDEX_NAME, H5_ITER_DEC, 2, &link_info, H5P_DEFAULT) <
            0) {
            printf("    failed to retrieve soft link's info at index %d\n", 2);
            TESTFRAME_TEST_ERROR(params);
        }
        ...
        memset(&link_info, 0, sizeof(link_info));
        if (H5Lget_info_by_idx2(subgroup_id, ".", H5_INDEX_NAME, H5_ITER_DEC, 1, &link_info, H5P_DEFAULT) <
            0) {
            printf("    failed to retrieve soft link's info at index %d\n", 1);
            TESTFRAME_TEST_ERROR(params);
        }
        ...
        memset(&link_info, 0, sizeof(link_info));
        if (H5Lget_info_by_idx2(subgroup_id, ".", H5_INDEX_NAME, H5_ITER_DEC, 0, &link_info, H5P_DEFAULT) <
            0) {
            printf("    failed to retrieve soft link's info at index %d\n", 0);
            TESTFRAME_TEST_ERROR(params);
        }
    ...
    SUBTEST_BEGIN(params, "H5Lget_val_by_idx on external link by creation order in increasing order")
    {
    ...
    SUBTEST_BEGIN(params, "H5Lget_val_by_idx on external link by creation order in decreasing order")
    {
        const char *ext_obj_name_a = "/A";
        const char *ext_obj_name_b = "/B";
        const char *ext_obj_name_c = "/C";
    ...
    SUBTEST_BEGIN(params, "H5Lget_val_by_idx on external link by alphabetical order in increasing order")
    {
        const char *ext_obj_name_a = "/A";
        const char *ext_obj_name_b = "/B";
        const char *ext_obj_name_c = "/C";
    ...
    SUBTEST_BEGIN(params, "H5Lget_val_by_idx on external link by alphabetical order in decreasing order")
    {
        const char *ext_obj_name_a = "/A";
        const char *ext_obj_name_b = "/B";
        const char *ext_obj_name_c = "/C";
    ...
    SUBTEST_BEGIN(params, "H5Lget_val_by_idx on user-defined link by creation order in increasing order")
    {
        TESTFRAME_SKIPPED(params);
    }
    SUBTEST_END(params);
    ...
    SUBTEST_BEGIN(params, "H5Lget_val_by_idx on user-defined link by creation order in decreasing order")
    {
        TESTFRAME_SKIPPED(params);
    }
    SUBTEST_END(params);
    ...
    SUBTEST_BEGIN(params, "H5Lget_val_by_idx on user-defined link by alphabetical order in increasing order")
    {
        TESTFRAME_SKIPPED(params);
    }
    SUBTEST_END(params);
    ...
    SUBTEST_BEGIN(params, "H5Lget_val_by_idx on user-defined link by alphabetical order in decreasing order")
    {
        TESTFRAME_SKIPPED(params);
    }
    SUBTEST_END(params);
 ...
 */
static herr_t
test_get_link_val_invalid_params(TestParams_t *params)
{
    H5L_info2_t link_info;
    htri_t      link_exists;
    herr_t      err_ret           = -1;
    ...
    SUBTEST_BEGIN(params, "H5Lget_val with an invalid location ID")
    {
        memset(&link_info, 0, sizeof(link_info));
    ...
    SUBTEST_BEGIN(params, "H5Lget_val with an invalid link name")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Lget_val with an invalid LAPL")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Lget_val_by_idx with an invalid location ID")
    {
        memset(&link_info, 0, sizeof(link_info));
    ...
    SUBTEST_BEGIN(params, "H5Lget_val_by_idx with an invalid group name")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Lget_val_by_idx with an invalid index type")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Lget_val_by_idx with an invalid iteration ordering")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Lget_val_by_idx with an invalid LAPL")
    {
        H5E_BEGIN_TRY
        {
            err_ret = H5Lget_val_by_idx(group_id, ".", H5_INDEX_NAME, H5_ITER_INC, 0, link_val_buf,
 ...
 */
static herr_t
test_get_link_info(TestParams_t *params)
{
    H5L_info2_t link_info;
    ...
    SUBTEST_BEGIN(params, "H5Lget_info2 on hard link")
    {
        memset(&link_info, 0, sizeof(link_info));
    ...
    SUBTEST_BEGIN(params, "H5Lget_info2 on soft link")
    {
        memset(&link_info, 0, sizeof(link_info));
    ...
    SUBTEST_BEGIN(params, "H5Lget_info2 on external link")
    {
        memset(&link_info, 0, sizeof(link_info));
        ...
        if (H5Lcreate_external(ext_link_filename, ext_objname, subgroup_id, GET_LINK_INFO_TEST_EXT_LINK_NAME,
                               H5P_DEFAULT, H5P_DEFAULT) < 0) {
    ...
    SUBTEST_BEGIN(params, "H5Lget_info2 on user-defined link")
    {
        /* TODO */
    ...
    SUBTEST_BEGIN(params, "H5Lget_info_by_idx2 on hard link by creation order in increasing order")
    {
        if (!(vol_cap_flags_g & H5VL_CAP_FLAG_CREATION_ORDER)) {
            TESTFRAME_SKIPPED(params);
            printf("    creation order tracking isn't supported with this VOL connector\n");
    ...
    SUBTEST_BEGIN(params, "H5Lget_info_by_idx2 on hard link by creation order in decreasing order")
    {
        if (!(vol_cap_flags_g & H5VL_CAP_FLAG_CREATION_ORDER)) {
            TESTFRAME_SKIPPED(params);
            printf("    creation order tracking isn't supported with this VOL connector\n");
    ...
    SUBTEST_BEGIN(params, "H5Lget_info_by_idx2 on hard link by alphabetical order in increasing order")
    {
    ...
    SUBTEST_BEGIN(params, "H5Lget_info_by_idx2 on hard link by alphabetical order in decreasing order")
    {
    ...
    SUBTEST_BEGIN(params, "H5Lget_info_by_idx2 on soft link by creation order in increasing order")
    {
        if (!(vol_cap_flags_g & H5VL_CAP_FLAG_CREATION_ORDER)) {
            TESTFRAME_SKIPPED(params);
            printf("    creation order tracking isn't supported with this VOL connector\n");
    ...
    SUBTEST_BEGIN(params, "H5Lget_info_by_idx2 on soft link by creation order in decreasing order")
    {
        if (!(vol_cap_flags_g & H5VL_CAP_FLAG_CREATION_ORDER)) {
            TESTFRAME_SKIPPED(params);
            printf("    creation order tracking isn't supported with this VOL connector\n");
    ...
    SUBTEST_BEGIN(params, "H5Lget_info_by_idx2 on soft link by alphabetical order in increasing order")
    {
    ...
    SUBTEST_BEGIN(params, "H5Lget_info_by_idx2 on soft link by alphabetical order in decreasing order")
    {
    ...
    SUBTEST_BEGIN(params, "H5Lget_info_by_idx2 on external link by creation order in increasing order")
    {
        if (!(vol_cap_flags_g & H5VL_CAP_FLAG_CREATION_ORDER)) {
            TESTFRAME_SKIPPED(params);
            printf("    creation order tracking isn't supported with this VOL connector\n");
        ...
        if (H5Lcreate_external(ext_link_filename, ext_objname, subgroup_id, GET_LINK_INFO_TEST_EXT_LINK_NAME2,
                               H5P_DEFAULT, H5P_DEFAULT) < 0) {
    ...
    SUBTEST_BEGIN(params, "H5Lget_info_by_idx2 on external link by creation order in decreasing order")
    {
        if (!(vol_cap_flags_g & H5VL_CAP_FLAG_CREATION_ORDER)) {
            TESTFRAME_SKIPPED(params);
            printf("    creation order tracking isn't supported with this VOL connector\n");
    ...
    SUBTEST_BEGIN(params, "H5Lget_info_by_idx2 on external link by alphabetical order in increasing order")
    {
    ...
    SUBTEST_BEGIN(params, "H5Lget_info_by_idx2 on external link by alphabetical order in decreasing order")
    {
    ...
    SUBTEST_BEGIN(params, "H5Lget_info_by_idx2 on user-defined link by creation order in increasing order")
    {
        TESTFRAME_SKIPPED(params);
    }
    SUBTEST_END(params);
    ...
    SUBTEST_BEGIN(params, "H5Lget_info_by_idx2 on user-defined link by creation order in decreasing order")
    {
        TESTFRAME_SKIPPED(params);
    }
    SUBTEST_END(params);
    ...
    SUBTEST_BEGIN(params,
                  "H5Lget_info_by_idx2 on user-defined link by alphabetical order in increasing order")
    {
        TESTFRAME_SKIPPED(params);
    }
    SUBTEST_END(params);
    ...
    SUBTEST_BEGIN(params,
                  "H5Lget_info_by_idx2 on user-defined link by alphabetical order in decreasing order")
    {
        TESTFRAME_SKIPPED(params);
    }
    SUBTEST_END(params);
 ...
 */
static herr_t
test_get_link_info_invalid_params(TestParams_t *params)
{
    H5L_info2_t link_info;
    herr_t      err_ret = -1;
    htri_t      link_exists;
    ...
    SUBTEST_BEGIN(params, "H5Lget_info2 with an invalid location ID")
    {
        memset(&link_info, 0, sizeof(link_info));
    ...
    SUBTEST_BEGIN(params, "H5Lget_info2 with an invalid link name")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Lget_info2 with an invalid LAPL")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Lget_info_by_idx2 with an invalid location ID")
    {
        memset(&link_info, 0, sizeof(link_info));
    ...
    SUBTEST_BEGIN(params, "H5Lget_info_by_idx2 with an invalid group name")
    {
        H5E_BEGIN_TRY
        {
            err_ret =
                H5Lget_info_by_idx2(group_id, NULL, H5_INDEX_NAME, H5_ITER_INC, 0, &link_info, H5P_DEFAULT);
        }
        H5E_END_TRY
    ...
    SUBTEST_BEGIN(params, "H5Lget_info_by_idx2 with an invalid index type")
    {
        H5E_BEGIN_TRY
        {
            err_ret =
                H5Lget_info_by_idx2(group_id, ".", H5_INDEX_UNKNOWN, H5_ITER_INC, 0, &link_info, H5P_DEFAULT);
        }
        H5E_END_TRY
        ...
        H5E_BEGIN_TRY
        {
            err_ret = H5Lget_info_by_idx2(group_id, ".", H5_INDEX_N, H5_ITER_INC, 0, &link_info, H5P_DEFAULT);
        }
        H5E_END_TRY
    ...
    SUBTEST_BEGIN(params, "H5Lget_info_by_idx2 with an invalid iteration ordering")
    {
        H5E_BEGIN_TRY
        {
        ...
        if (err_ret >= 0) {
            printf("    H5Lget_info_by_idx2 succeeded with invalid iteration ordering H5_ITER_UNKNOWN!\n");
            TESTFRAME_TEST_ERROR(params);
        }
    ...
    SUBTEST_BEGIN(params, "H5Lget_info_by_idx2 with an invalid LAPL")
    {
        H5E_BEGIN_TRY
        {
 ...
 */
static herr_t
test_get_link_name(TestParams_t *params)
{
    ...
    SUBTEST_BEGIN(params, "H5Lget_name_by_idx on hard link by creation order in increasing order")
    {
        if (!(vol_cap_flags_g & H5VL_CAP_FLAG_CREATION_ORDER)) {
            TESTFRAME_SKIPPED(params);
            printf("    creation order tracking isn't supported with this VOL connector\n");
        ...
        if ((subgroup_id = H5Gcreate2(group_id, GET_LINK_NAME_TEST_HARD_SUBGROUP_NAME, H5P_DEFAULT, gcpl_id,
                                      H5P_DEFAULT)) < 0) {
    ...
    SUBTEST_BEGIN(params, "H5Lget_name_by_idx on hard link by creation order in decreasing order")
    {
        if (!(vol_cap_flags_g & H5VL_CAP_FLAG_CREATION_ORDER)) {
            TESTFRAME_SKIPPED(params);
            printf("    creation order tracking isn't supported with this VOL connector\n");
        ...
        /* Create group to hold some links */
        if ((subgroup_id = H5Gcreate2(group_id, GET_LINK_NAME_TEST_HARD_SUBGROUP_NAME2, H5P_DEFAULT, gcpl_id,
                                      H5P_DEFAULT)) < 0) {
    ...
    SUBTEST_BEGIN(params, "H5Lget_name_by_idx on hard link by alphabetical order in increasing order")
    {
        /* Create group to hold some links */
        if ((subgroup_id = H5Gcreate2(group_id, GET_LINK_NAME_TEST_HARD_SUBGROUP_NAME3, H5P_DEFAULT, gcpl_id,
                                      H5P_DEFAULT)) < 0) {
        ...
        /* Retrieve link names */
        if ((link_name_buf_size = H5Lget_name_by_idx(subgroup_id, ".", H5_INDEX_NAME, H5_ITER_INC, 0, NULL, 0,
                                                     H5P_DEFAULT)) < 0) {
            printf("    failed to retrieve link name size\n");
            TESTFRAME_TEST_ERROR(params);
        }
        ...
        if ((link_name_buf_size = H5Lget_name_by_idx(subgroup_id, ".", H5_INDEX_NAME, H5_ITER_INC, 1, NULL, 0,
                                                     H5P_DEFAULT)) < 0) {
            printf("    failed to retrieve link name size\n");
            TESTFRAME_TEST_ERROR(params);
        }
        ...
        if ((link_name_buf_size = H5Lget_name_by_idx(subgroup_id, ".", H5_INDEX_NAME, H5_ITER_INC, 2, NULL, 0,
                                                     H5P_DEFAULT)) < 0) {
            printf("    failed to retrieve link name size\n");
            TESTFRAME_TEST_ERROR(params);
        }
    ...
    SUBTEST_BEGIN(params, "H5Lget_name_by_idx on hard link by alphabetical order in decreasing order")
    {
        /* Create group to hold some links */
        if ((subgroup_id = H5Gcreate2(group_id, GET_LINK_NAME_TEST_HARD_SUBGROUP_NAME4, H5P_DEFAULT, gcpl_id,
                                      H5P_DEFAULT)) < 0) {
        ...
        /* Retrieve link names */
        if ((link_name_buf_size = H5Lget_name_by_idx(subgroup_id, ".", H5_INDEX_NAME, H5_ITER_DEC, 0, NULL, 0,
                                                     H5P_DEFAULT)) < 0) {
            printf("    failed to retrieve link name size\n");
            TESTFRAME_TEST_ERROR(params);
        }
        ...
        if ((link_name_buf_size = H5Lget_name_by_idx(subgroup_id, ".", H5_INDEX_NAME, H5_ITER_DEC, 1, NULL, 0,
                                                     H5P_DEFAULT)) < 0) {
            printf("    failed to retrieve link name size\n");
            TESTFRAME_TEST_ERROR(params);
        }
        ...
        if ((link_name_buf_size = H5Lget_name_by_idx(subgroup_id, ".", H5_INDEX_NAME, H5_ITER_DEC, 2, NULL, 0,
                                                     H5P_DEFAULT)) < 0) {
            printf("    failed to retrieve link name size\n");
            TESTFRAME_TEST_ERROR(params);
        }
    ...
    SUBTEST_BEGIN(params, "H5Lget_name_by_idx on soft link by creation order in increasing order")
    {
        if (!(vol_cap_flags_g & H5VL_CAP_FLAG_CREATION_ORDER)) {
            TESTFRAME_SKIPPED(params);
            printf("    creation order tracking isn't supported with this VOL connector\n");
        ...
        /* Create group to hold some links */
        if ((subgroup_id = H5Gcreate2(group_id, GET_LINK_NAME_TEST_SOFT_SUBGROUP_NAME, H5P_DEFAULT, gcpl_id,
                                      H5P_DEFAULT)) < 0) {
    ...
    SUBTEST_BEGIN(params, "H5Lget_name_by_idx on soft link by creation order in decreasing order")
    {
        if (!(vol_cap_flags_g & H5VL_CAP_FLAG_CREATION_ORDER)) {
            TESTFRAME_SKIPPED(params);
            printf("    creation order tracking isn't supported with this VOL connector\n");
        ...
        /* Create group to hold some links */
        if ((subgroup_id = H5Gcreate2(group_id, GET_LINK_NAME_TEST_SOFT_SUBGROUP_NAME2, H5P_DEFAULT, gcpl_id,
                                      H5P_DEFAULT)) < 0) {
    ...
    SUBTEST_BEGIN(params, "H5Lget_name_by_idx on soft link by alphabetical order in increasing order")
    {
        /* Create group to hold some links */
        if ((subgroup_id = H5Gcreate2(group_id, GET_LINK_NAME_TEST_SOFT_SUBGROUP_NAME3, H5P_DEFAULT, gcpl_id,
                                      H5P_DEFAULT)) < 0) {
    ...
    SUBTEST_BEGIN(params, "H5Lget_name_by_idx on soft link by alphabetical order in decreasing order")
    {
        /* Create group to hold some links */
        if ((subgroup_id = H5Gcreate2(group_id, GET_LINK_NAME_TEST_SOFT_SUBGROUP_NAME4, H5P_DEFAULT, gcpl_id,
                                      H5P_DEFAULT)) < 0) {
    ...
    SUBTEST_BEGIN(params, "H5Lget_name_by_idx on external link by creation order in increasing order")
    {
        if (!(vol_cap_flags_g & H5VL_CAP_FLAG_CREATION_ORDER)) {
            TESTFRAME_SKIPPED(params);
            printf("    creation order tracking isn't supported with this VOL connector\n");
        ...
        if (H5Lcreate_external(ext_link_filename, "/", subgroup_id, GET_LINK_NAME_TEST_EXTERNAL_LINK_NAME3,
                               H5P_DEFAULT, H5P_DEFAULT) < 0) {
            printf("    failed to create external link '%s'\n", GET_LINK_NAME_TEST_EXTERNAL_LINK_NAME3);
            TESTFRAME_TEST_ERROR(params);
        }

        if (H5Lcreate_external(ext_link_filename, "/", subgroup_id, GET_LINK_NAME_TEST_EXTERNAL_LINK_NAME2,
                               H5P_DEFAULT, H5P_DEFAULT) < 0) {
    ...
    SUBTEST_BEGIN(params, "H5Lget_name_by_idx on external link by creation order in decreasing order")
    {
        if (!(vol_cap_flags_g & H5VL_CAP_FLAG_CREATION_ORDER)) {
            TESTFRAME_SKIPPED(params);
            printf("    creation order tracking isn't supported with this VOL connector\n");
    ...
    SUBTEST_BEGIN(params, "H5Lget_name_by_idx on external link by alphabetical order in increasing order")
    {
        /* Create group to hold some links */
    ...
    SUBTEST_BEGIN(params, "H5Lget_name_by_idx on external link by alphabetical order in decreasing order")
    {
        /* Create group to hold some links */
    ...
    SUBTEST_BEGIN(params, "H5Lget_name_by_idx on user-defined link by creation order in increasing order")
    {
        /* TODO */
    ...
    SUBTEST_BEGIN(params, "H5Lget_name_by_idx on user-defined link by creation order in decreasing order")
    {
        /* TODO */
    ...
    SUBTEST_BEGIN(params, "H5Lget_name_by_idx on user-defined link by alphabetical order in increasing order")
    {
        /* TODO */
    ...
    SUBTEST_BEGIN(params, "H5Lget_name_by_idx on user-defined link by alphabetical order in decreasing order")
    {
        /* TODO */
 ...
 */
static herr_t
test_get_link_name_invalid_params(TestParams_t *params)
{
    ssize_t ret;
    htri_t  link_exists;
    ...
    SUBTEST_BEGIN(params, "H5Lget_name_by_idx with an invalid location ID")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Lget_name_by_idx with an invalid group name")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Lget_name_by_idx with an invalid index type")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Lget_name_by_idx with an invalid iteration ordering")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Lget_name_by_idx with an invalid LAPL")
    {
        H5E_BEGIN_TRY
        {
            ret = H5Lget_name_by_idx(group_id, ".", H5_INDEX_NAME, H5_ITER_INC, 0, link_name_buf,
 ...
 */
static herr_t
test_link_iterate_hard_links(TestParams_t *params)
{
    size_t i;
    htri_t link_exists;
    hid_t  file_id         = H5I_INVALID_HID;
    ...
    SUBTEST_BEGIN(params, "H5Literate2 by link name in increasing order")
    {
    ...
    SUBTEST_BEGIN(params, "H5Literate2 by link name in decreasing order")
    {
    ...
    SUBTEST_BEGIN(params, "H5Literate2 by creation order in increasing order")
    {
        if (!(vol_cap_flags_g & H5VL_CAP_FLAG_CREATION_ORDER)) {
            TESTFRAME_SKIPPED(params);
            printf("    creation order tracking isn't supported with this VOL connector\n");
    ...
    SUBTEST_BEGIN(params, "H5Literate2 by creation order in decreasing order")
    {
        if (!(vol_cap_flags_g & H5VL_CAP_FLAG_CREATION_ORDER)) {
            TESTFRAME_SKIPPED(params);
            printf("    creation order tracking isn't supported with this VOL connector\n");
    ...
    SUBTEST_BEGIN(params, "H5Literate_by_name2 by link name in increasing order")
    {
        /* Reset the counter to the appropriate value for the next test */
        i = 0;

        if (H5Literate_by_name2(file_id, "/" LINK_TEST_GROUP_NAME "/" LINK_ITER_HARD_LINKS_TEST_SUBGROUP_NAME,
                                H5_INDEX_NAME, H5_ITER_INC, NULL, link_iter_hard_links_cb, &i,
                                H5P_DEFAULT) < 0) {
    ...
    SUBTEST_BEGIN(params, "H5Literate_by_name2 by link name in decreasing order")
    {
        /* Reset the counter to the appropriate value for the next test */
        i = LINK_ITER_HARD_LINKS_TEST_NUM_LINKS;

        if (H5Literate_by_name2(file_id, "/" LINK_TEST_GROUP_NAME "/" LINK_ITER_HARD_LINKS_TEST_SUBGROUP_NAME,
                                H5_INDEX_NAME, H5_ITER_DEC, NULL, link_iter_hard_links_cb, &i,
                                H5P_DEFAULT) < 0) {
    ...
    SUBTEST_BEGIN(params, "H5Literate_by_name2 by creation order in increasing order")
    {
        if (!(vol_cap_flags_g & H5VL_CAP_FLAG_CREATION_ORDER)) {
            TESTFRAME_SKIPPED(params);
            printf("    creation order tracking isn't supported with this VOL connector\n");
        ...
        if (H5Literate_by_name2(file_id, "/" LINK_TEST_GROUP_NAME "/" LINK_ITER_HARD_LINKS_TEST_SUBGROUP_NAME,
                                H5_INDEX_CRT_ORDER, H5_ITER_INC, NULL, link_iter_hard_links_cb, &i,
                                H5P_DEFAULT) < 0) {
    ...
    SUBTEST_BEGIN(params, "H5Literate_by_name2 by creation order in decreasing order")
    {
        if (!(vol_cap_flags_g & H5VL_CAP_FLAG_CREATION_ORDER)) {
            TESTFRAME_SKIPPED(params);
            printf("    creation order tracking isn't supported with this VOL connector\n");
        ...
        if (H5Literate_by_name2(file_id, "/" LINK_TEST_GROUP_NAME "/" LINK_ITER_HARD_LINKS_TEST_SUBGROUP_NAME,
                                H5_INDEX_CRT_ORDER, H5_ITER_DEC, NULL, link_iter_hard_links_cb, &i,
                                H5P_DEFAULT) < 0) {
 ...
 */
static herr_t
test_link_iterate_soft_links(TestParams_t *params)
{
    size_t i;
    htri_t link_exists;
    hid_t  file_id         = H5I_INVALID_HID;
    ...
    SUBTEST_BEGIN(params, "H5Literate_by_name2 by link name in increasing order")
    {
        ...
        if (H5Literate_by_name2(file_id, "/" LINK_TEST_GROUP_NAME "/" LINK_ITER_SOFT_LINKS_TEST_SUBGROUP_NAME,
                                H5_INDEX_NAME, H5_ITER_INC, NULL, link_iter_soft_links_cb, &i,
                                H5P_DEFAULT) < 0) {
            printf("    H5Literate_by_name2 by index type name in increasing order failed\n");
            TESTFRAME_TEST_ERROR(params);
        }
    ...
    SUBTEST_BEGIN(params, "H5Literate_by_name2 by link name in decreasing order")
    {
        ...
        if (H5Literate_by_name2(file_id, "/" LINK_TEST_GROUP_NAME "/" LINK_ITER_SOFT_LINKS_TEST_SUBGROUP_NAME,
                                H5_INDEX_NAME, H5_ITER_DEC, NULL, link_iter_soft_links_cb, &i,
                                H5P_DEFAULT) < 0) {
            printf("    H5Literate_by_name2 by index type name in decreasing order failed\n");
            TESTFRAME_TEST_ERROR(params);
        }
    ...
    SUBTEST_BEGIN(params, "H5Literate_by_name2 by creation order in increasing order")
    {
        ...
        if (H5Literate_by_name2(file_id, "/" LINK_TEST_GROUP_NAME "/" LINK_ITER_SOFT_LINKS_TEST_SUBGROUP_NAME,
                                H5_INDEX_CRT_ORDER, H5_ITER_INC, NULL, link_iter_soft_links_cb, &i,
                                H5P_DEFAULT) < 0) {
            printf("    H5Literate_by_name2 by index type creation order in increasing order failed\n");
            TESTFRAME_TEST_ERROR(params);
        }
    ...
    SUBTEST_BEGIN(params, "H5Literate_by_name2 by creation order in decreasing order")
    {
        ...
        if (H5Literate_by_name2(file_id, "/" LINK_TEST_GROUP_NAME "/" LINK_ITER_SOFT_LINKS_TEST_SUBGROUP_NAME,
                                H5_INDEX_CRT_ORDER, H5_ITER_DEC, NULL, link_iter_soft_links_cb, &i,
                                H5P_DEFAULT) < 0) {
            printf("    H5Literate_by_name2 by index type creation order in decreasing order failed\n");
            TESTFRAME_TEST_ERROR(params);
        }
 ...
 */
static herr_t
test_link_iterate_external_links(TestParams_t *params)
{
    size_t i;
    htri_t link_exists;
    hid_t  file_id         = H5I_INVALID_HID;
    ...
    SUBTEST_BEGIN(params, "H5Literate2 by creation order in increasing order")
    {
        ...
        if (H5Literate2(group_id, H5_INDEX_CRT_ORDER, H5_ITER_INC, NULL, link_iter_external_links_cb, &i) <
            0) {
            printf("    H5Literate2 by index type creation order in increasing order failed\n");
            TESTFRAME_TEST_ERROR(params);
        }
    ...
    SUBTEST_BEGIN(params, "H5Literate2 by creation order in decreasing order")
    {
        ...
        if (H5Literate2(group_id, H5_INDEX_CRT_ORDER, H5_ITER_DEC, NULL, link_iter_external_links_cb, &i) <
            0) {
            printf("    H5Literate2 by index type creation order in decreasing order failed\n");
            TESTFRAME_TEST_ERROR(params);
        }
    ...
    SUBTEST_BEGIN(params, "H5Literate_by_name2 by link name in increasing order")
    {
        ...
        if (H5Literate_by_name2(file_id, "/" LINK_TEST_GROUP_NAME "/" LINK_ITER_EXT_LINKS_TEST_SUBGROUP_NAME,
                                H5_INDEX_NAME, H5_ITER_INC, NULL, link_iter_external_links_cb, &i,
                                H5P_DEFAULT) < 0) {
            printf("    H5Literate_by_name2 by index type name in increasing order failed\n");
            TESTFRAME_TEST_ERROR(params);
        }
    ...
    SUBTEST_BEGIN(params, "H5Literate_by_name2 by link name in decreasing order")
    {
        ...
        if (H5Literate_by_name2(file_id, "/" LINK_TEST_GROUP_NAME "/" LINK_ITER_EXT_LINKS_TEST_SUBGROUP_NAME,
                                H5_INDEX_NAME, H5_ITER_DEC, NULL, link_iter_external_links_cb, &i,
                                H5P_DEFAULT) < 0) {
            printf("    H5Literate_by_name2 by index type name in decreasing order failed\n");
            TESTFRAME_TEST_ERROR(params);
        }
 ...
 */
static herr_t
test_link_iterate_ud_links(TestParams_t H5_ATTR_UNUSED *params)
{
    return SKIP;
}
 ...
 */
static herr_t
test_link_iterate_mixed_links(TestParams_t *params)
{
    hsize_t saved_idx;
    size_t  i;
    htri_t  link_exists;
    ...
    SUBTEST_BEGIN(params, "H5Literate_by_name2 by link name in increasing order")
    {
        ...
        if (H5Literate_by_name2(
                file_id, "/" LINK_TEST_GROUP_NAME "/" LINK_ITER_MIXED_LINKS_TEST_SUBGROUP_NAME, H5_INDEX_NAME,
                H5_ITER_INC, NULL, link_iter_mixed_links_cb, &i, H5P_DEFAULT) < 0) {
            printf("    H5Literate_by_name2 by index type name in increasing order failed\n");
            TESTFRAME_TEST_ERROR(params);
        }
    ...
    SUBTEST_BEGIN(params, "H5Literate_by_name2 by link name in decreasing order")
    {
        ...
        if (H5Literate_by_name2(
                file_id, "/" LINK_TEST_GROUP_NAME "/" LINK_ITER_MIXED_LINKS_TEST_SUBGROUP_NAME, H5_INDEX_NAME,
                H5_ITER_DEC, NULL, link_iter_mixed_links_cb, &i, H5P_DEFAULT) < 0) {
            printf("    H5Literate_by_name2 by index type name in decreasing order failed\n");
            TESTFRAME_TEST_ERROR(params);
        }
    ...
    SUBTEST_BEGIN(params, "H5Literate2 index-saving capabilities in increasing order")
    {
        if (!(vol_cap_flags_g & H5VL_CAP_FLAG_CREATION_ORDER) ||
            !(vol_cap_flags_g & H5VL_CAP_FLAG_EXTERNAL_LINKS) ||
            !(vol_cap_flags_g & H5VL_CAP_FLAG_UD_LINKS)) {
...
#ifdef BROKEN
    SUBTEST_BEGIN(params, "H5Literate2 index-saving capabilities in decreasing order")
    {
        if (!(vol_cap_flags_g & H5VL_CAP_FLAG_CREATION_ORDER) ||
            !(vol_cap_flags_g & H5VL_CAP_FLAG_EXTERNAL_LINKS) ||
            !(vol_cap_flags_g & H5VL_CAP_FLAG_UD_LINKS)) {
 ...
 */
static herr_t
test_link_iterate_invalid_params(TestParams_t *params)
{
    herr_t err_ret = -1;
    size_t i;
    htri_t link_exists;
    ...
    SUBTEST_BEGIN(params, "H5Literate2 with an invalid group ID")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Literate2 with an invalid index type")
    {
        H5E_BEGIN_TRY
        {
            err_ret =
                H5Literate2(group_id, H5_INDEX_UNKNOWN, H5_ITER_INC, NULL, link_iter_invalid_params_cb, NULL);
        }
        H5E_END_TRY
        ...
        H5E_BEGIN_TRY
        {
            err_ret = H5Literate2(group_id, H5_INDEX_N, H5_ITER_INC, NULL, link_iter_invalid_params_cb, NULL);
        }
        H5E_END_TRY
    ...
    SUBTEST_BEGIN(params, "H5Literate2 with an invalid iteration ordering")
    {
        H5E_BEGIN_TRY
        {
            err_ret = H5Literate2(group_id, H5_INDEX_NAME, H5_ITER_UNKNOWN, NULL, link_iter_invalid_params_cb,
                                  NULL);
        }
        H5E_END_TRY
    ...
    SUBTEST_BEGIN(params, "H5Literate_by_name2 with an invalid location ID")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Literate_by_name2 with an invalid group name")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Literate_by_name2 with an invalid index type")
    {
        H5E_BEGIN_TRY
        {
            err_ret = H5Literate_by_name2(
        ...
        {
            err_ret = H5Literate_by_name2(
                file_id, "/" LINK_TEST_GROUP_NAME "/" LINK_ITER_INVALID_PARAMS_TEST_SUBGROUP_NAME, H5_INDEX_N,
                H5_ITER_INC, NULL, link_iter_invalid_params_cb, NULL, H5P_DEFAULT);
        }
        H5E_END_TRY
    ...
    SUBTEST_BEGIN(params, "H5Literate_by_name2 with an invalid iteration ordering")
    {
        H5E_BEGIN_TRY
        {
            err_ret = H5Literate_by_name2(
        ...
        if (err_ret >= 0) {
            printf("    H5Literate_by_name2 succeeded with invalid iteration ordering H5_ITER_UNKNOWN!\n");
            TESTFRAME_TEST_ERROR(params);
        }
    ...
    SUBTEST_BEGIN(params, "H5Literate_by_name2 with an invalid LAPL")
    {
        H5E_BEGIN_TRY
        {
            err_ret = H5Literate_by_name2(
 ...
 */
static herr_t
test_link_iterate_0_links(TestParams_t *params)
{
    hid_t file_id         = H5I_INVALID_HID;
    hid_t container_group = H5I_INVALID_HID, group_id = H5I_INVALID_HID;
    hid_t gcpl_id = H5I_INVALID_HID;
    ...
    SUBTEST_BEGIN(params, "H5Literate2 by creation order in increasing order")
    {
        ...
        if (H5Literate2(group_id, H5_INDEX_CRT_ORDER, H5_ITER_INC, NULL, link_iter_0_links_cb, NULL) < 0) {
            printf("    H5Literate2 by index type creation order in increasing order failed\n");
            TESTFRAME_TEST_ERROR(params);
        }
    }
    ...
    SUBTEST_BEGIN(params, "H5Literate2 by creation order in decreasing order")
    {
        ...
        if (H5Literate2(group_id, H5_INDEX_CRT_ORDER, H5_ITER_DEC, NULL, link_iter_0_links_cb, NULL) < 0) {
            printf("    H5Literate2 by index type creation order in decreasing order failed\n");
            TESTFRAME_TEST_ERROR(params);
        }
    }
    ...
    SUBTEST_BEGIN(params, "H5Literate_by_name2 by link name in increasing order")
    {
        if (H5Literate_by_name2(file_id, "/" LINK_TEST_GROUP_NAME "/" LINK_ITER_0_LINKS_TEST_SUBGROUP_NAME,
                                H5_INDEX_NAME, H5_ITER_INC, NULL, link_iter_0_links_cb, NULL,
                                H5P_DEFAULT) < 0) {
            printf("    H5Literate_by_name2 by index type name in increasing order failed\n");
            TESTFRAME_TEST_ERROR(params);
        }
    ...
    {
        if (H5Literate_by_name2(file_id, "/" LINK_TEST_GROUP_NAME "/" LINK_ITER_0_LINKS_TEST_SUBGROUP_NAME,
                                H5_INDEX_NAME, H5_ITER_DEC, NULL, link_iter_0_links_cb, NULL,
                                H5P_DEFAULT) < 0) {
            printf("    H5Literate_by_name2 by index type name in decreasing order failed\n");
            TESTFRAME_TEST_ERROR(params);
        }
    ...
    SUBTEST_BEGIN(params, "H5Literate_by_name2 by creation order in increasing order")
    {
        ...
        if (H5Literate_by_name2(file_id, "/" LINK_TEST_GROUP_NAME "/" LINK_ITER_0_LINKS_TEST_SUBGROUP_NAME,
                                H5_INDEX_CRT_ORDER, H5_ITER_INC, NULL, link_iter_0_links_cb, NULL,
                                H5P_DEFAULT) < 0) {
            printf("    H5Literate_by_name2 by index type creation order in increasing order failed\n");
            TESTFRAME_TEST_ERROR(params);
        }
    ...
    SUBTEST_BEGIN(params, "H5Literate_by_name2 by creation order in decreasing order")
    {
        ...
        if (H5Literate_by_name2(file_id, "/" LINK_TEST_GROUP_NAME "/" LINK_ITER_0_LINKS_TEST_SUBGROUP_NAME,
                                H5_INDEX_CRT_ORDER, H5_ITER_DEC, NULL, link_iter_0_links_cb, NULL,
                                H5P_DEFAULT) < 0) {
            printf("    H5Literate_by_name2 by index type creation order in decreasing order failed\n");
            TESTFRAME_TEST_ERROR(params);
        }
 ...
 */
static herr_t
test_link_visit_hard_links_no_cycles(TestParams_t *params)
{
    size_t i;
    htri_t link_exists;
    hid_t  file_id         = H5I_INVALID_HID;
    ...
    SUBTEST_BEGIN(params, "H5Lvisit2 by link name in increasing order")
    {
        i = 0;
    ...
    SUBTEST_BEGIN(params, "H5Lvisit2 by link name in decreasing order")
    {
        /* Reset the counter to the appropriate value for the next test */
    ...
    SUBTEST_BEGIN(params, "H5Lvisit2 by creation order in increasing order")
    {
        if (!(vol_cap_flags_g & H5VL_CAP_FLAG_CREATION_ORDER)) {
            TESTFRAME_SKIPPED(params);
            printf("    creation order tracking isn't supported with this VOL connector\n");
    ...
    SUBTEST_BEGIN(params, "H5Lvisit2 by creation order in decreasing order")
    {
        if (!(vol_cap_flags_g & H5VL_CAP_FLAG_CREATION_ORDER)) {
            TESTFRAME_SKIPPED(params);
            printf("    creation order tracking isn't supported with this VOL connector\n");
    ...
    SUBTEST_BEGIN(params, "H5Lvisit_by_name2 by link name in increasing order")
    {
        /* Reset the counter to the appropriate value for the next test */
        i = 0;
    ...
    SUBTEST_BEGIN(params, "H5Lvisit_by_name2 by link name in decreasing order")
    {
        /* Reset the counter to the appropriate value for the next test */
        i = LINK_VISIT_HARD_LINKS_NO_CYCLE_TEST_NUM_LINKS_PER_TEST;
    ...
    SUBTEST_BEGIN(params, "H5Lvisit_by_name2 by creation order in increasing order")
    {
        if (!(vol_cap_flags_g & H5VL_CAP_FLAG_CREATION_ORDER)) {
            TESTFRAME_SKIPPED(params);
            printf("    creation order tracking isn't supported with this VOL connector\n");
    ...
    SUBTEST_BEGIN(params, "H5Lvisit_by_name2 by creation order in decreasing order")
    {
        if (!(vol_cap_flags_g & H5VL_CAP_FLAG_CREATION_ORDER)) {
            TESTFRAME_SKIPPED(params);
            printf("    creation order tracking isn't supported with this VOL connector\n");
 ...
 */
static herr_t
test_link_visit_soft_links_no_cycles(TestParams_t *params)
{
    size_t i;
    htri_t link_exists;
    hid_t  file_id         = H5I_INVALID_HID;
 ...
 */
static herr_t
test_link_visit_external_links_no_cycles(TestParams_t *params)
{
    size_t i;
    htri_t link_exists;
    hid_t  file_id         = H5I_INVALID_HID;
    ...
    SUBTEST_BEGIN(params, "H5Lvisit2 by creation order in increasing order")
    {
        ...
        if (H5Lvisit2(group_id, H5_INDEX_CRT_ORDER, H5_ITER_INC, link_visit_external_links_no_cycles_cb, &i) <
            0) {
            printf("    H5Lvisit2 by index type creation order in increasing order failed\n");
            TESTFRAME_TEST_ERROR(params);
        }
    ...
    SUBTEST_BEGIN(params, "H5Lvisit2 by creation order in decreasing order")
    {
        ...
        if (H5Lvisit2(group_id, H5_INDEX_CRT_ORDER, H5_ITER_DEC, link_visit_external_links_no_cycles_cb, &i) <
            0) {
            printf("    H5Lvisit2 by index type creation order in decreasing order failed\n");
            TESTFRAME_TEST_ERROR(params);
        }
 ...
 */
static herr_t
test_link_visit_ud_links_no_cycles(TestParams_t H5_ATTR_UNUSED *params)
{
    return SKIP;
}
 ...
 */
static herr_t
test_link_visit_mixed_links_no_cycles(TestParams_t *params)
{
    size_t i;
    htri_t link_exists;
    hid_t  file_id         = H5I_INVALID_HID;
    ...
    SUBTEST_BEGIN(params, "H5Lvisit2 by creation order in increasing order")
    {
        ...
        if (H5Lvisit2(group_id, H5_INDEX_CRT_ORDER, H5_ITER_INC, link_visit_mixed_links_no_cycles_cb, &i) <
            0) {
            printf("    H5Lvisit2 by index type creation order in increasing order failed\n");
            TESTFRAME_TEST_ERROR(params);
        }
    ...
    SUBTEST_BEGIN(params, "H5Lvisit2 by creation order in decreasing order")
    {
        ...
        if (H5Lvisit2(group_id, H5_INDEX_CRT_ORDER, H5_ITER_DEC, link_visit_mixed_links_no_cycles_cb, &i) <
            0) {
            printf("    H5Lvisit2 by index type creation order in decreasing order failed\n");
            TESTFRAME_TEST_ERROR(params);
        }
 ...
 */
static herr_t
test_link_visit_hard_links_cycles(TestParams_t *params)
{
    size_t i;
    htri_t link_exists;
    hid_t  file_id         = H5I_INVALID_HID;
 ...
 */
static herr_t
test_link_visit_soft_links_cycles(TestParams_t *params)
{
    size_t i;
    htri_t link_exists;
    hid_t  file_id         = H5I_INVALID_HID;
 ...
 */
static herr_t
test_link_visit_external_links_cycles(TestParams_t *params)
{
    size_t i;
    htri_t link_exists;
    hid_t  file_id         = H5I_INVALID_HID;
    ...
    for (i = 0; i < LINK_VISIT_EXT_LINKS_CYCLE_TEST_NUM_SUBGROUPS; i++) {
        ...
        for (j = 0; j < LINK_VISIT_EXT_LINKS_CYCLE_TEST_NUM_LINKS_PER_GROUP; j++) {
            ...
            if (H5Lcreate_external(H5_API_TEST_FILENAME(params), link_target_obj, subgroup_id, link_name,
                                   H5P_DEFAULT, H5P_DEFAULT) < 0) {
                printf("    couldn't create external link '%s'\n", link_name);
                goto error;
            }
    ...
    SUBTEST_BEGIN(params, "H5Lvisit2 by creation order in increasing order")
    {
        ...
        if (H5Lvisit2(group_id, H5_INDEX_CRT_ORDER, H5_ITER_INC, link_visit_external_links_cycles_cb, &i) <
            0) {
            printf("    H5Lvisit2 by index type creation order in increasing order failed\n");
            TESTFRAME_TEST_ERROR(params);
        }
    ...
    SUBTEST_BEGIN(params, "H5Lvisit2 by creation order in decreasing order")
    {
        ...
        if (H5Lvisit2(group_id, H5_INDEX_CRT_ORDER, H5_ITER_DEC, link_visit_external_links_cycles_cb, &i) <
            0) {
            printf("    H5Lvisit2 by index type creation order in decreasing order failed\n");
            TESTFRAME_TEST_ERROR(params);
        }
 ...
 */
static herr_t
test_link_visit_ud_links_cycles(TestParams_t H5_ATTR_UNUSED *params)
{
    return SKIP;
}
 ...
 */
static herr_t
test_link_visit_mixed_links_cycles(TestParams_t *params)
{
    htri_t link_exists;
    size_t i;
    hid_t  file_id         = H5I_INVALID_HID;
 ...
 */
static herr_t
test_link_visit_invalid_params(TestParams_t *params)
{
    herr_t err_ret = -1;
    htri_t link_exists;
    hid_t  file_id         = H5I_INVALID_HID;
    ...
    SUBTEST_BEGIN(params, "H5Lvisit2 with an invalid group ID")
    {
        H5E_BEGIN_TRY
        {
            err_ret =
                H5Lvisit2(H5I_INVALID_HID, H5_INDEX_NAME, H5_ITER_INC, link_visit_invalid_params_cb, NULL);
        }
        H5E_END_TRY
    ...
    SUBTEST_BEGIN(params, "H5Lvisit2 with an invalid index type")
    {
        H5E_BEGIN_TRY
        {
            err_ret = H5Lvisit2(group_id, H5_INDEX_UNKNOWN, H5_ITER_INC, link_visit_invalid_params_cb, NULL);
        }
        H5E_END_TRY
    ...
    SUBTEST_BEGIN(params, "H5Lvisit2 with an invalid iteration ordering")
    {
        H5E_BEGIN_TRY
        {
            err_ret = H5Lvisit2(group_id, H5_INDEX_NAME, H5_ITER_UNKNOWN, link_visit_invalid_params_cb, NULL);
        }
        H5E_END_TRY
    ...
    SUBTEST_BEGIN(params, "H5Lvisit_by_name2 with an invalid location ID")
    {
        H5E_BEGIN_TRY
        {
            err_ret = H5Lvisit_by_name2(
                H5I_INVALID_HID, "/" LINK_TEST_GROUP_NAME "/" LINK_VISIT_INVALID_PARAMS_TEST_SUBGROUP_NAME,
    ...
    SUBTEST_BEGIN(params, "H5Lvisit_by_name2 with an invalid group name")
    {
        H5E_BEGIN_TRY
        {
        ...
        H5E_BEGIN_TRY
        {
            err_ret = H5Lvisit_by_name2(file_id, "", H5_INDEX_NAME, H5_ITER_INC, link_visit_invalid_params_cb,
                                        NULL, H5P_DEFAULT);
        }
        H5E_END_TRY
    ...
    SUBTEST_BEGIN(params, "H5Lvisit_by_name2 with an invalid index type")
    {
        H5E_BEGIN_TRY
        {
            err_ret = H5Lvisit_by_name2(
    ...
    SUBTEST_BEGIN(params, "H5Lvisit_by_name2 with an invalid iteration ordering")
    {
        H5E_BEGIN_TRY
        {
            err_ret = H5Lvisit_by_name2(
    ...
    SUBTEST_BEGIN(params, "H5Lvisit_by_name2 with an invalid LAPL")
    {
        H5E_BEGIN_TRY
        {
            err_ret = H5Lvisit_by_name2(
 ...
 */
static herr_t
test_link_visit_0_links(TestParams_t *params)
{
    hid_t file_id         = H5I_INVALID_HID;
    hid_t container_group = H5I_INVALID_HID, group_id = H5I_INVALID_HID;
    hid_t gcpl_id = H5I_INVALID_HID;
...
H5_api_link_test_add(void)
{
    ...
    AddTest("test_create_hard_link", test_create_hard_link, NULL, NULL, NULL, 0, testframe_flags,
            "hard link creation");
    ...
    AddTest("test_create_soft_link_invalid_params", test_create_soft_link_invalid_params, NULL, NULL, NULL, 0,
            testframe_flags, "soft link creation with invalid parameters");
    AddTest("test_create_external_link", test_create_external_link, NULL, NULL, NULL, 0, testframe_flags,
    ...
    AddTest("test_create_external_link_dangling", test_create_external_link_dangling, NULL, NULL, NULL, 0,
            testframe_flags, "dangling external link creation");
    AddTest("test_create_external_link_multi", test_create_external_link_multi, NULL, NULL, NULL, 0,
            testframe_flags, "external link creation to an object across several files");
    AddTest("test_create_external_link_ping_pong", test_create_external_link_ping_pong, NULL, NULL, NULL, 0,
            testframe_flags, "external link creation to an object in ping pong style");
    AddTest("test_create_external_link_invalid_params", test_create_external_link_invalid_params, NULL, NULL,
            NULL, 0, testframe_flags, "H5Lcreate_external with invalid parameters");
    AddTest("test_create_user_defined_link", test_create_user_defined_link, NULL, NULL, NULL, 0,
            testframe_flags, "user-defined link creation");
    AddTest("test_create_user_defined_link_invalid_params", test_create_user_defined_link_invalid_params,
            NULL, NULL, NULL, 0, testframe_flags, "H5Lcreate_ud with invalid parameters");
    AddTest("test_delete_link", test_delete_link, NULL, NULL, NULL, 0, testframe_flags, "link deletion");
    AddTest("test_delete_link_reset_grp_max_crt_order", test_delete_link_reset_grp_max_crt_order, NULL, NULL,
            NULL, 0, testframe_flags,
            "H5Ldelete of all links in group resets group's maximum link creation order value");
    AddTest("test_delete_link_invalid_params", test_delete_link_invalid_params, NULL, NULL, NULL, 0,
            testframe_flags, "H5Ldelete with invalid parameters");
    AddTest("test_copy_link", test_copy_link, NULL, NULL, NULL, 0, testframe_flags, "link copying");
    AddTest("test_copy_links_into_group_with_links", test_copy_links_into_group_with_links, NULL, NULL, NULL,
            0, testframe_flags, "H5Lcopy adjusting creation order values for copied links");
    AddTest("test_copy_link_across_files", test_copy_link_across_files, NULL, NULL, NULL, 0, testframe_flags,
            "link copying across files");
    AddTest("test_copy_link_invalid_params", test_copy_link_invalid_params, NULL, NULL, NULL, 0,
            testframe_flags, "H5Lcopy with invalid parameters");
    AddTest("test_move_link", test_move_link, NULL, NULL, NULL, 0, testframe_flags, "link moving");
    AddTest("test_move_links_into_group_with_links", test_move_links_into_group_with_links, NULL, NULL, NULL,
            0, testframe_flags, "H5Lmove adjusting creation order values for moved links");
    AddTest("test_move_link_across_files", test_move_link_across_files, NULL, NULL, NULL, 0, testframe_flags,
            "link moving across files");
    AddTest("test_move_link_reset_grp_max_crt_order", test_move_link_reset_grp_max_crt_order, NULL, NULL,
            NULL, 0, testframe_flags,
            "H5Lmove of all links out of group resets group's maximum link creation order value");
    AddTest("test_move_link_invalid_params", test_move_link_invalid_params, NULL, NULL, NULL, 0,
            testframe_flags, "H5Lmove with invalid parameters");
    AddTest("test_get_link_val", test_get_link_val, NULL, NULL, NULL, 0, testframe_flags,
            "link value retrieval");
    AddTest("test_get_link_val_invalid_params", test_get_link_val_invalid_params, NULL, NULL, NULL, 0,
            testframe_flags, "link value retrieval with invalid parameters");
    AddTest("test_get_link_info", test_get_link_info, NULL, NULL, NULL, 0, testframe_flags,
            "link info retrieval");
    AddTest("test_get_link_info_invalid_params", test_get_link_info_invalid_params, NULL, NULL, NULL, 0,
            testframe_flags, "link info retrieval with invalid parameters");
    AddTest("test_get_link_name", test_get_link_name, NULL, NULL, NULL, 0, testframe_flags,
            "link name retrieval");
    AddTest("test_get_link_name_invalid_params", test_get_link_name_invalid_params, NULL, NULL, NULL, 0,
            testframe_flags, "link name retrieval with invalid parameters");
    AddTest("test_link_iterate_hard_links", test_link_iterate_hard_links, NULL, NULL, NULL, 0,
            testframe_flags, "link iteration (only hard links)");
    AddTest("test_link_iterate_soft_links", test_link_iterate_soft_links, NULL, NULL, NULL, 0,
            testframe_flags, "link iteration (only soft links)");
    AddTest("test_link_iterate_external_links", test_link_iterate_external_links, NULL, NULL, NULL, 0,
            testframe_flags, "link iteration (only external links)");
    AddTest("test_link_iterate_ud_links", test_link_iterate_ud_links, NULL, NULL, NULL, 0, testframe_flags,
    ...
    AddTest("test_link_iterate_mixed_links", test_link_iterate_mixed_links, NULL, NULL, NULL, 0,
            testframe_flags, "link iteration (mixed link types)");
    AddTest("test_link_iterate_invalid_params", test_link_iterate_invalid_params, NULL, NULL, NULL, 0,
            testframe_flags, "link iteration with invalid parameters");
    AddTest("test_link_iterate_0_links", test_link_iterate_0_links, NULL, NULL, NULL, 0, testframe_flags,
