...
static herr_t test_create_anonymous_committed_datatype_invalid_params(TestParams_t *params);
#ifndef PROBLEMATIC_TESTS
static herr_t test_create_committed_datatype_empty_types(TestParams_t *params);
#endif
static herr_t test_recommit_committed_type(TestParams_t *params);
static herr_t test_open_committed_datatype(TestParams_t *params);
static herr_t test_open_committed_datatype_invalid_params(TestParams_t *params);
static herr_t test_reopen_committed_datatype_indirect(TestParams_t *params);
static herr_t test_close_committed_datatype_invalid_id(TestParams_t *params);
static herr_t test_datatype_property_lists(TestParams_t *params);
static herr_t test_create_dataset_with_committed_type(TestParams_t *params);
static herr_t test_create_attribute_with_committed_type(TestParams_t *params);
static herr_t test_delete_committed_type(TestParams_t *params);
static herr_t test_resurrect_datatype(TestParams_t *params);
static herr_t test_flush_committed_datatype(TestParams_t *params);
static herr_t test_flush_committed_datatype_invalid_params(TestParams_t *params);
static herr_t test_refresh_committed_datatype(TestParams_t *params);
static herr_t test_refresh_committed_datatype_invalid_params(TestParams_t *params);
#ifndef PROBLEMATIC_TESTS
static herr_t test_cant_commit_predefined(TestParams_t *params);
#endif
 ...
 */
static herr_t
test_create_committed_datatype(TestParams_t *params)
{
 ...
 */
static herr_t
test_create_committed_datatype_invalid_params(TestParams_t *params)
{
    herr_t err_ret         = -1;
    hid_t  file_id         = H5I_INVALID_HID;
    hid_t  container_group = H5I_INVALID_HID, group_id = H5I_INVALID_HID;
    ...
    SUBTEST_BEGIN(params, "H5Tcommit2 with an invalid loc_id")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Tcommit2 with an invalid datatype name")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Tcommit2 with an invalid datatype ID")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Tcommit2 with an invalid LCPL")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Tcommit2 with an invalid TCPL")
    {
        H5E_BEGIN_TRY
        {
            err_ret = H5Tcommit2(group_id, DATATYPE_CREATE_INVALID_PARAMS_TEST_TYPE_NAME, type_id,
    ...
    SUBTEST_BEGIN(params, "H5Tcommit2 with an invalid TAPL")
    {
        H5E_BEGIN_TRY
        {
            err_ret = H5Tcommit2(group_id, DATATYPE_CREATE_INVALID_PARAMS_TEST_TYPE_NAME, type_id,
 ...
 */
static herr_t
test_create_anonymous_committed_datatype(TestParams_t *params)
{
    hid_t file_id         = H5I_INVALID_HID;
    hid_t container_group = H5I_INVALID_HID, group_id = H5I_INVALID_HID;
    hid_t type_id = H5I_INVALID_HID;
 ...
 */
static herr_t
test_create_anonymous_committed_datatype_invalid_params(TestParams_t *params)
{
    herr_t err_ret         = -1;
    hid_t  file_id         = H5I_INVALID_HID;
    hid_t  container_group = H5I_INVALID_HID, group_id = H5I_INVALID_HID;
    ...
    SUBTEST_BEGIN(params, "H5Tcommit_anon with an invalid loc_id")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Tcommit_anon with an invalid datatype ID")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Tcommit_anon with an invalid TCPL")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Tcommit_anon with an invalid TAPL")
    {
        H5E_BEGIN_TRY
        {
...
#ifndef PROBLEMATIC_TESTS
static herr_t
test_create_committed_datatype_empty_types(TestParams_t *params)
{
    herr_t err_ret         = FAIL;
    hid_t  file_id         = H5I_INVALID_HID;
    hid_t  container_group = H5I_INVALID_HID, group_id = H5I_INVALID_HID;
    ...
    SUBTEST_BEGIN(params, "creation of committed datatype with empty compound type")
    {
    ...
    SUBTEST_BEGIN(params, "creation of committed datatype with empty enum type")
    {
        int enum_val = 1;
 ...
 */
static herr_t
test_recommit_committed_type(TestParams_t *params)
{
 ...
 */
static herr_t
test_open_committed_datatype(TestParams_t *params)
{
    hid_t file_id         = H5I_INVALID_HID;
    hid_t container_group = H5I_INVALID_HID, group_id = H5I_INVALID_HID;
    hid_t type_id = H5I_INVALID_HID;
 ...
 */
static herr_t
test_open_committed_datatype_invalid_params(TestParams_t *params)
{
    hid_t file_id         = H5I_INVALID_HID;
    hid_t container_group = H5I_INVALID_HID, group_id = H5I_INVALID_HID;
    hid_t type_id = H5I_INVALID_HID;
    ...
    SUBTEST_BEGIN(params, "H5Topen2 with an invalid location ID")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Topen2 with an invalid datatype name")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Topen2 with an invalid TAPL")
    {
        H5E_BEGIN_TRY
        {
 ...
 */
static herr_t
test_reopen_committed_datatype_indirect(TestParams_t *params)
{
    size_t dt_size         = 0;
    hid_t  file_id         = H5I_INVALID_HID;
    ...
    SUBTEST_BEGIN(params, "re-open of compound datatype")
    {
    ...
    SUBTEST_BEGIN(params, "re-open of enum datatype")
    {
        int enum_value;
    ...
    SUBTEST_BEGIN(params, "reopen of a variable-length datatype")
    {
    ...
    SUBTEST_BEGIN(params, "reopen of an opaque datatype")
    {
    ...
    SUBTEST_BEGIN(params, "reopen of an array datatype")
    {
 ...
 */
static herr_t
test_close_committed_datatype_invalid_id(TestParams_t *params)
{
    herr_t err_ret = -1;
    hid_t  file_id = H5I_INVALID_HID;
 ...
 */
static herr_t
test_datatype_property_lists(TestParams_t *params)
{
    hid_t file_id         = H5I_INVALID_HID;
    hid_t container_group = H5I_INVALID_HID, group_id = H5I_INVALID_HID;
    ...
    SUBTEST_BEGIN(params, "H5Tget_create_plist")
    {
 ...
 */
static herr_t
test_create_dataset_with_committed_type(TestParams_t *params)
{
    hid_t file_id         = H5I_INVALID_HID;
    hid_t container_group = H5I_INVALID_HID, group_id = H5I_INVALID_HID;
    hid_t dset_id   = H5I_INVALID_HID;
 ...
 */
static herr_t
test_create_attribute_with_committed_type(TestParams_t *params)
{
    htri_t attr_exists;
    hid_t  file_id         = H5I_INVALID_HID;
    hid_t  container_group = H5I_INVALID_HID, group_id = H5I_INVALID_HID;
 ...
 */
static herr_t
test_delete_committed_type(TestParams_t *params)
{
    htri_t type_exists;
    hid_t  file_id         = H5I_INVALID_HID;
    hid_t  container_group = H5I_INVALID_HID, group_id = H5I_INVALID_HID;
 ...
 */
static herr_t
test_resurrect_datatype(TestParams_t *params)
{
    hid_t file_id         = H5I_INVALID_HID;
    hid_t container_group = H5I_INVALID_HID;
    hid_t group_id        = H5I_INVALID_HID;
...
static herr_t
test_flush_committed_datatype(TestParams_t H5_ATTR_UNUSED *params)
{
    return SKIP;
}

static herr_t
test_flush_committed_datatype_invalid_params(TestParams_t H5_ATTR_UNUSED *params)
{
    return SKIP;
}

static herr_t
test_refresh_committed_datatype(TestParams_t H5_ATTR_UNUSED *params)
{
    return SKIP;
}

static herr_t
test_refresh_committed_datatype_invalid_params(TestParams_t H5_ATTR_UNUSED *params)
{
    return SKIP;
}
...
#ifndef PROBLEMATIC_TESTS
static herr_t
test_cant_commit_predefined(TestParams_t *params)
{
    herr_t err_ret;
    hid_t  file_id         = H5I_INVALID_HID;
    hid_t  container_group = H5I_INVALID_HID;
 ...
 */
static herr_t
test_cant_modify_committed_type(TestParams_t *params)
{
    htri_t is_committed = false;
    herr_t err_ret;
    hid_t  file_id         = H5I_INVALID_HID;
