...
static herr_t test_create_attribute_with_null_space(TestParams_t *params);
static herr_t test_create_attribute_with_scalar_space(TestParams_t *params);
static herr_t test_create_attribute_with_space_in_name(TestParams_t *params);
static herr_t test_create_attribute_invalid_params(TestParams_t *params);
static herr_t test_open_attribute(TestParams_t *params);
static herr_t test_open_attribute_invalid_params(TestParams_t *params);
static herr_t test_write_attribute(TestParams_t *params);
static herr_t test_write_attribute_invalid_params(TestParams_t *params);
static herr_t test_read_attribute(TestParams_t *params);
static herr_t test_read_attribute_invalid_params(TestParams_t *params);
static herr_t test_read_empty_attribute(TestParams_t *params);
static herr_t test_close_attribute_invalid_id(TestParams_t *params);
static herr_t test_get_attribute_space_and_type(TestParams_t *params);
static herr_t test_get_attribute_space_and_type_invalid_params(TestParams_t *params);
static herr_t test_attribute_property_lists(TestParams_t *params);
static herr_t test_get_attribute_name(TestParams_t *params);
static herr_t test_get_attribute_name_invalid_params(TestParams_t *params);
static herr_t test_get_attribute_storage_size(TestParams_t *params);
static herr_t test_get_attribute_info(TestParams_t *params);
static herr_t test_get_attribute_info_invalid_params(TestParams_t *params);
static herr_t test_rename_attribute(TestParams_t *params);
static herr_t test_rename_attribute_invalid_params(TestParams_t *params);
static herr_t test_attribute_iterate_group(TestParams_t *params);
static herr_t test_attribute_iterate_dataset(TestParams_t *params);
static herr_t test_attribute_iterate_datatype(TestParams_t *params);
static herr_t test_attribute_iterate_index_saving(TestParams_t *params);
static herr_t test_attribute_iterate_invalid_params(TestParams_t *params);
static herr_t test_attribute_iterate_0_attributes(TestParams_t *params);
static herr_t test_attribute_compound_subset(TestParams_t *params);
static herr_t test_attribute_string_encodings(TestParams_t *params);
static herr_t test_delete_attribute(TestParams_t *params);
static herr_t test_delete_attribute_invalid_params(TestParams_t *params);
static herr_t test_attribute_exists(TestParams_t *params);
static herr_t test_attribute_exists_invalid_params(TestParams_t *params);
static herr_t test_attribute_many(TestParams_t *params);
static herr_t test_attribute_duplicate_id(TestParams_t *params);
static herr_t test_get_number_attributes(TestParams_t *params);
static herr_t test_attr_shared_dtype(TestParams_t *params);
 ...
 */
static herr_t
test_create_attribute_on_root(TestParams_t *params)
{
    htri_t attr_exists;
    ...
    SUBTEST_BEGIN(params, "H5Acreate on the root group")
    {
    ...
    SUBTEST_BEGIN(params, "H5Acreate_by_name on the root group")
    {
 ...
 */
static herr_t
test_create_attribute_on_dataset(TestParams_t *params)
{
    htri_t attr_exists;
    hid_t  file_id         = H5I_INVALID_HID;
 ...
 */
static herr_t
test_create_attribute_on_datatype(TestParams_t *params)
{
    htri_t attr_exists;
    hid_t  file_id         = H5I_INVALID_HID;
    hid_t  container_group = H5I_INVALID_HID;
    ...
    SUBTEST_BEGIN(params, "H5Acreate on a committed datatype")
    {
    ...
    SUBTEST_BEGIN(params, "H5Acreate_by_name on a committed datatype")
    {
 ...
 */
static herr_t
test_create_attribute_with_null_space(TestParams_t *params)
{
    htri_t attr_exists;
    hid_t  file_id         = H5I_INVALID_HID;
 ...
 */
static herr_t
test_create_attribute_with_scalar_space(TestParams_t *params)
{
    htri_t attr_exists;
    hid_t  file_id         = H5I_INVALID_HID;
    hid_t  container_group = H5I_INVALID_HID, group_id = H5I_INVALID_HID;
 ...
 */
static herr_t
test_create_attribute_with_space_in_name(TestParams_t *params)
{
    htri_t attr_exists;
    hid_t  file_id         = H5I_INVALID_HID;
    hid_t  container_group = H5I_INVALID_HID;
 ...
 */
static herr_t
test_create_attribute_invalid_params(TestParams_t *params)
{
    hid_t file_id         = H5I_INVALID_HID;
    hid_t container_group = H5I_INVALID_HID, group_id = H5I_INVALID_HID;
    hid_t attr_id    = H5I_INVALID_HID;
    ...
    SUBTEST_BEGIN(params, "H5Acreate with invalid loc_id")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Acreate with invalid attribute name")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Acreate with an invalid datatype")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Acreate with an invalid dataspace")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Acreate with an invalid ACPL")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Acreate with an invalid AAPL")
    {
        H5E_BEGIN_TRY
        {
            attr_id = H5Acreate2(group_id, ATTRIBUTE_CREATE_INVALID_PARAMS_ATTR_NAME, attr_dtype, space_id,
    ...
    SUBTEST_BEGIN(params, "H5Acreate_by_name with an invalid loc_id")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Acreate_by_name with invalid object name")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Acreate_by_name with invalid attribute name")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Acreate_by_name with invalid datatype")
    {
        H5E_BEGIN_TRY
        {
            attr_id = H5Acreate_by_name(container_group, ATTRIBUTE_CREATE_INVALID_PARAMS_GROUP_NAME,
    ...
    SUBTEST_BEGIN(params, "H5Acreate_by_name with invalid dataspace")
    {
        H5E_BEGIN_TRY
        {
            attr_id = H5Acreate_by_name(container_group, ATTRIBUTE_CREATE_INVALID_PARAMS_GROUP_NAME,
    ...
    SUBTEST_BEGIN(params, "H5Acreate_by_name with invalid ACPL")
    {
        H5E_BEGIN_TRY
        {
            attr_id = H5Acreate_by_name(container_group, ATTRIBUTE_CREATE_INVALID_PARAMS_GROUP_NAME,
    ...
    SUBTEST_BEGIN(params, "H5Acreate_by_name with invalid AAPL")
    {
        H5E_BEGIN_TRY
        {
            attr_id = H5Acreate_by_name(container_group, ATTRIBUTE_CREATE_INVALID_PARAMS_GROUP_NAME,
    ...
    SUBTEST_BEGIN(params, "H5Acreate_by_name with invalid LAPL")
    {
        H5E_BEGIN_TRY
        {
            attr_id = H5Acreate_by_name(container_group, ATTRIBUTE_CREATE_INVALID_PARAMS_GROUP_NAME,
 ...
 */
static herr_t
test_open_attribute(TestParams_t *params)
{
    hid_t file_id         = H5I_INVALID_HID;
    hid_t container_group = H5I_INVALID_HID, group_id = H5I_INVALID_HID;
    hid_t attr_id   = H5I_INVALID_HID;
    ...
    SUBTEST_BEGIN(params, "H5Aopen_by_name")
    {
    ...
    SUBTEST_BEGIN(params, "H5Aopen_by_idx by creation order in increasing order")
    {
        if (!(vol_cap_flags_g & H5VL_CAP_FLAG_CREATION_ORDER)) {
    ...
    SUBTEST_BEGIN(params, "H5Aopen_by_idx by creation order in decreasing order")
    {
        if (!(vol_cap_flags_g & H5VL_CAP_FLAG_CREATION_ORDER)) {
            TESTFRAME_SKIPPED(params);
            printf("    creation order tracking is not supported with this VOL connector\n");
    ...
    SUBTEST_BEGIN(params, "H5Aopen_by_idx by alphabetical order in increasing order")
    {
    ...
    SUBTEST_BEGIN(params, "H5Aopen_by_idx by alphabetical order in decreasing order")
    {
        if ((attr_id = H5Aopen_by_idx(container_group, ATTRIBUTE_OPEN_TEST_GROUP_NAME, H5_INDEX_NAME,
                                      H5_ITER_DEC, 2, H5P_DEFAULT, H5P_DEFAULT)) < 0) {
 ...
 */
static herr_t
test_open_attribute_invalid_params(TestParams_t *params)
{
    hid_t file_id         = H5I_INVALID_HID;
    hid_t container_group = H5I_INVALID_HID, group_id = H5I_INVALID_HID;
    hid_t attr_id   = H5I_INVALID_HID;
    ...
    SUBTEST_BEGIN(params, "H5Aopen with an invalid loc_id")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Aopen with an invalid attribute name")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Aopen with an invalid AAPL")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Aopen_by_name with an invalid loc_id")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Aopen_by_name with an invalid object name")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Aopen_by_name with an invalid attribute name")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Aopen_by_name with an invalid AAPL")
    {
        H5E_BEGIN_TRY
        {
            attr_id =
    ...
    SUBTEST_BEGIN(params, "H5Aopen_by_name with an invalid LAPL")
    {
        H5E_BEGIN_TRY
        {
            attr_id =
    ...
    SUBTEST_BEGIN(params, "H5Aopen_by_idx with an invalid loc_id")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Aopen_by_idx with an invalid object name")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Aopen_by_idx with an invalid index type")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Aopen_by_idx with an invalid iteration order")
    {
        H5E_BEGIN_TRY
        {
            attr_id = H5Aopen_by_idx(container_group, ATTRIBUTE_OPEN_INVALID_PARAMS_TEST_GROUP_NAME,
    ...
    SUBTEST_BEGIN(params, "H5Aopen_by_idx with an invalid AAPL")
    {
        H5E_BEGIN_TRY
        {
            attr_id = H5Aopen_by_idx(container_group, ATTRIBUTE_OPEN_INVALID_PARAMS_TEST_GROUP_NAME,
    ...
    SUBTEST_BEGIN(params, "H5Aopen_by_idx with an invalid LAPL")
    {
        H5E_BEGIN_TRY
        {
            attr_id = H5Aopen_by_idx(container_group, ATTRIBUTE_OPEN_INVALID_PARAMS_TEST_GROUP_NAME,
 ...
 */
static herr_t
test_write_attribute(TestParams_t *params)
{
 ...
 */
static herr_t
test_write_attribute_invalid_params(TestParams_t *params)
{
    ...
    SUBTEST_BEGIN(params, "H5Awrite with an invalid attr_id")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Awrite with an invalid datatype")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Awrite with an invalid data buffer")
    {
        H5E_BEGIN_TRY
        {
 ...
 */
static herr_t
test_read_attribute(TestParams_t *params)
{
 ...
 */
static herr_t
test_read_attribute_invalid_params(TestParams_t *params)
{
    ...
    SUBTEST_BEGIN(params, "H5Aread with an invalid attr_id")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Aread with an invalid datatype")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Aread with an invalid read buffer")
    {
        H5E_BEGIN_TRY
        {
 ...
 */
static herr_t
test_read_empty_attribute(TestParams_t *params)
{
 ...
 */
static herr_t
test_close_attribute_invalid_id(TestParams_t *params)
{
    herr_t err_ret = -1;
    hid_t  file_id = H5I_INVALID_HID;
 ...
 */
static herr_t
test_get_attribute_space_and_type(TestParams_t *params)
{
    ...
    SUBTEST_BEGIN(params, "H5Aget_type")
    {
    ...
    SUBTEST_BEGIN(params, "H5Aget_space")
    {
    ...
    SUBTEST_BEGIN(params, "H5Aget_type after re-opening an attribute")
    {
    ...
    SUBTEST_BEGIN(params, "H5Aget_space after re-opening an attribute")
    {
        if ((attr_id = H5Aopen(group_id, ATTRIBUTE_GET_SPACE_TYPE_TEST_ATTR_NAME, H5P_DEFAULT)) < 0) {
            printf("    couldn't open attribute '%s'\n", ATTRIBUTE_GET_SPACE_TYPE_TEST_ATTR_NAME);
            TESTFRAME_TEST_ERROR(params);
 ...
 */
static herr_t
test_get_attribute_space_and_type_invalid_params(TestParams_t *params)
{
    htri_t attr_exists;
    hid_t  file_id         = H5I_INVALID_HID;
    hid_t  container_group = H5I_INVALID_HID;
    ...
    SUBTEST_BEGIN(params, "H5Aget_type with an invalid attr_id")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Aget_space with an invalid attr_id")
    {
        H5E_BEGIN_TRY
        {
 ...
 */
static herr_t
test_attribute_property_lists(TestParams_t *params)
{
    ...
    SUBTEST_BEGIN(params, "H5Aget_create_plist")
    {
 ...
 */
static herr_t
test_get_attribute_name(TestParams_t *params)
{
    ...
    SUBTEST_BEGIN(params, "H5Aget_name")
    {
    ...
    SUBTEST_BEGIN(params, "H5Aget_name_by_idx by creation order in increasing order")
    {
        if (!(vol_cap_flags_g & H5VL_CAP_FLAG_CREATION_ORDER)) {
            TESTFRAME_SKIPPED(params);
    ...
    SUBTEST_BEGIN(params, "H5Aget_name_by_idx by creation order in decreasing order")
    {
        if (!(vol_cap_flags_g & H5VL_CAP_FLAG_CREATION_ORDER)) {
            TESTFRAME_SKIPPED(params);
            printf("    creation order tracking isn't supported with this VOL connector\n");
    ...
    SUBTEST_BEGIN(params, "H5Aget_name_by_idx by alphabetical order in increasing order")
    {
        *name_buf = '\0';
    ...
    SUBTEST_BEGIN(params, "H5Aget_name_by_idx by alphabetical order in decreasing order")
    {
        *name_buf = '\0';
        if (H5Aget_name_by_idx(container_group, ATTRIBUTE_GET_NAME_TEST_GROUP_NAME, H5_INDEX_NAME,
                               H5_ITER_DEC, 2, name_buf, (size_t)name_buf_size, H5P_DEFAULT) < 0) {
 ...
 */
static herr_t
test_get_attribute_name_invalid_params(TestParams_t *params)
{
    ssize_t name_buf_size;
    htri_t  attr_exists;
    hid_t   file_id         = H5I_INVALID_HID;
    ...
    SUBTEST_BEGIN(params, "H5Aget_name with an invalid attr_id")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Aget_name with an invalid name buffer")
    {
        H5E_BEGIN_TRY
        {
            name_buf_size = 1;
    ...
    SUBTEST_BEGIN(params, "H5Aget_name_by_idx with an invalid loc_id")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Aget_name_by_idx with an invalid object name")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Aget_name_by_idx with an invalid index type")
    {
        H5E_BEGIN_TRY
        {
            name_buf_size = H5Aget_name_by_idx(
    ...
    SUBTEST_BEGIN(params, "H5Aget_name_by_idx with an invalid iteration order")
    {
        H5E_BEGIN_TRY
        {
            name_buf_size = H5Aget_name_by_idx(
    ...
    SUBTEST_BEGIN(params, "H5Aget_name_by_idx with an invalid name buffer")
    {
        H5E_BEGIN_TRY
        {
            name_buf_size = 1;
    ...
    SUBTEST_BEGIN(params, "H5Aget_name_by_idx with an invalid LAPL")
    {
        H5E_BEGIN_TRY
        {
            name_buf_size = H5Aget_name_by_idx(
 ...
 */
static herr_t
test_get_attribute_storage_size(TestParams_t H5_ATTR_UNUSED *params)
{
    return SKIP;
}
 ...
 */
static herr_t
test_get_attribute_info(TestParams_t *params)
{
    ...
    SUBTEST_BEGIN(params, "H5Aget_info")
    {
    ...
    SUBTEST_BEGIN(params, "H5Aget_info_by_idx by creation order in increasing order")
    {
        if (!(vol_cap_flags_g & H5VL_CAP_FLAG_CREATION_ORDER)) {
            TESTFRAME_SKIPPED(params);
            printf("    creation order tracking isn't supported with this VOL connector\n");
    ...
    SUBTEST_BEGIN(params, "H5Aget_info_by_idx by creation order in decreasing order")
    {
        if (!(vol_cap_flags_g & H5VL_CAP_FLAG_CREATION_ORDER)) {
            TESTFRAME_SKIPPED(params);
            printf("    creation order tracking isn't supported with this VOL connector\n");
 ...
 */
static herr_t
test_get_attribute_info_invalid_params(TestParams_t *params)
{
    H5A_info_t attr_info;
    htri_t     attr_exists;
    herr_t     err_ret         = -1;
    ...
    SUBTEST_BEGIN(params, "H5Aget_info with an invalid attr_id")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Aget_info with an invalid attribute info pointer")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Aget_info_by_name with an invalid loc_id")
    {
        H5E_BEGIN_TRY
        {
            err_ret =
    ...
    SUBTEST_BEGIN(params, "H5Aget_info_by_name with an invalid object name")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Aget_info_by_name with an invalid attribute name")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Aget_info_by_name with an invalid attribute info pointer")
    {
        H5E_BEGIN_TRY
        {
            err_ret = H5Aget_info_by_name(group_id, ".", ATTRIBUTE_GET_INFO_INVALID_PARAMS_TEST_ATTR_NAME,
    ...
    SUBTEST_BEGIN(params, "H5Aget_info_by_name with an invalid LAPL")
    {
        H5E_BEGIN_TRY
        {
            err_ret = H5Aget_info_by_name(group_id, ".", ATTRIBUTE_GET_INFO_INVALID_PARAMS_TEST_ATTR_NAME,
    ...
    SUBTEST_BEGIN(params, "H5Aget_info_by_idx with an invalid loc_id")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Aget_info_by_idx with an invalid object name")
    {
        H5E_BEGIN_TRY
        {
            err_ret =
    ...
    SUBTEST_BEGIN(params, "H5Aget_info_by_idx with an invalid index type")
    {
        H5E_BEGIN_TRY
        {
            err_ret =
    ...
    SUBTEST_BEGIN(params, "H5Aget_info_by_idx with an invalid iteration order")
    {
        H5E_BEGIN_TRY
        {
            err_ret =
    ...
    SUBTEST_BEGIN(params, "H5Aget_info_by_idx with an invalid attribute info pointer")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Aget_info_by_idx with an invalid LAPL")
    {
        H5E_BEGIN_TRY
        {
            err_ret =
 ...
 */
static herr_t
test_rename_attribute(TestParams_t *params)
{
    htri_t attr_exists;
    hid_t  file_id         = H5I_INVALID_HID;
    hid_t  container_group = H5I_INVALID_HID;
    ...
    SUBTEST_BEGIN(params, "H5Arename")
    {
    ...
    SUBTEST_BEGIN(params, "H5Arename_by_name")
    {
 ...
 */
static herr_t
test_rename_attribute_invalid_params(TestParams_t *params)
{
    htri_t attr_exists;
    herr_t err_ret         = -1;
    hid_t  file_id         = H5I_INVALID_HID;
    ...
    SUBTEST_BEGIN(params, "H5Arename with an invalid loc_id")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Arename with an invalid old attribute name")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Arename with an invalid new attribute name")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Arename_by_name with an invalid loc_id")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Arename_by_name with an invalid object name")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Arename_by_name with an invalid old attribute name")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Arename_by_name with an invalid new attribute name")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Arename_by_name with an invalid LAPL")
    {
        H5E_BEGIN_TRY
        {
            err_ret = H5Arename_by_name(group_id, ".", ATTRIBUTE_RENAME_INVALID_PARAMS_TEST_ATTR_NAME,
 ...
 */
static herr_t
test_attribute_iterate_group(TestParams_t *params)
{
    size_t link_counter;
    size_t i;
    htri_t attr_exists;
    ...
    SUBTEST_BEGIN(params, "H5Aiterate by attribute name in increasing order")
    {
        link_counter = 0;
    ...
    SUBTEST_BEGIN(params, "H5Aiterate by attribute name in decreasing order")
    {
    ...
    SUBTEST_BEGIN(params, "H5Aiterate by creation order in increasing order")
    {
        if (!(vol_cap_flags_g & H5VL_CAP_FLAG_CREATION_ORDER)) {
            TESTFRAME_SKIPPED(params);
            printf("    creation order tracking isn't supported with this VOL connector\n");
    ...
    SUBTEST_BEGIN(params, "H5Aiterate by creation order in decreasing order")
    {
        if (!(vol_cap_flags_g & H5VL_CAP_FLAG_CREATION_ORDER)) {
            TESTFRAME_SKIPPED(params);
            printf("    creation order tracking isn't supported with this VOL connector\n");
    ...
    SUBTEST_BEGIN(params, "H5Aiterate_by_name by attribute name in increasing order")
    {
        /* Reset the counter to the appropriate value for the next test */
        link_counter = 0;
    ...
    SUBTEST_BEGIN(params, "H5Aiterate_by_name by attribute name in decreasing order")
    {
        /* Reset the counter to the appropriate value for the next test */
        link_counter = ATTRIBUTE_ITERATE_TEST_NUM_ATTRS;
    ...
    SUBTEST_BEGIN(params, "H5Aiterate_by_name by creation order in increasing order")
    {
        if (!(vol_cap_flags_g & H5VL_CAP_FLAG_CREATION_ORDER)) {
            TESTFRAME_SKIPPED(params);
            printf("    creation order tracking isn't supported with this VOL connector\n");
    ...
    SUBTEST_BEGIN(params, "H5Aiterate_by_name by creation order in decreasing order")
    {
        if (!(vol_cap_flags_g & H5VL_CAP_FLAG_CREATION_ORDER)) {
            TESTFRAME_SKIPPED(params);
            printf("    creation order tracking isn't supported with this VOL connector\n");
 ...
 */
static herr_t
test_attribute_iterate_dataset(TestParams_t *params)
{
    size_t link_counter;
    size_t i;
    htri_t attr_exists;
 ...
 */
static herr_t
test_attribute_iterate_datatype(TestParams_t *params)
{
    size_t link_counter;
    size_t i;
    htri_t attr_exists;
 ...
 */
static herr_t
test_attribute_iterate_index_saving(TestParams_t H5_ATTR_UNUSED *params)
{
    return SKIP;
}
 ...
 */
static herr_t
test_attribute_iterate_invalid_params(TestParams_t *params)
{
    herr_t err_ret = -1;
    htri_t attr_exists;
    hid_t  file_id         = H5I_INVALID_HID;
    ...
    SUBTEST_BEGIN(params, "H5Aiterate with an invalid loc_id")
    {
        H5E_BEGIN_TRY
        {
            err_ret =
    ...
    SUBTEST_BEGIN(params, "H5Aiterate with an invalid index type")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Aiterate with an invalid index ordering")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Aiterate_by_name with an invalid loc_id")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Aiterate_by_name with an invalid object name")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Aiterate_by_name with an invalid index type")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Aiterate_by_name with an invalid index ordering")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Aiterate_by_name with an invalid LAPL")
    {
        H5E_BEGIN_TRY
        {
            err_ret = H5Aiterate_by_name(group_id, ".", H5_INDEX_NAME, H5_ITER_INC, NULL, attr_iter_callback2,
 ...
 */
static herr_t
test_attribute_iterate_0_attributes(TestParams_t *params)
{
    hid_t file_id         = H5I_INVALID_HID;
    hid_t container_group = H5I_INVALID_HID, group_id = H5I_INVALID_HID;
    hid_t dset_id       = H5I_INVALID_HID;
    ...
    SUBTEST_BEGIN(params, "H5Aiterate (native order)")
    {
    ...
    SUBTEST_BEGIN(params, "H5Aiterate (increasing order)")
    {
    ...
    SUBTEST_BEGIN(params, "H5Aiterate (decreasing order)")
    {
    ...
    SUBTEST_BEGIN(params, "H5Aiterate_by_name (native order)")
    {
    ...
    SUBTEST_BEGIN(params, "H5Aiterate_by_name (increasing order)")
    {
        if (H5Aiterate_by_name(group_id, ATTRIBUTE_ITERATE_TEST_0_ATTRIBUTES_DSET_NAME, H5_INDEX_NAME,
    ...
    SUBTEST_BEGIN(params, "H5Aiterate_by_name (decreasing order)")
    {
        if (H5Aiterate_by_name(group_id, ATTRIBUTE_ITERATE_TEST_0_ATTRIBUTES_DSET_NAME, H5_INDEX_NAME,
 ...
 */
static herr_t
test_attribute_compound_subset(TestParams_t *params)
{
    ...
    SUBTEST_BEGIN(params, "H5Awrite then H5Aread with all compound members")
    {
        /* Initialize wbuf */
    ...
    SUBTEST_BEGIN(params, "H5Aread with compound member a")
    {
        /* Initialize rbuf to -1 */
        for (i = 0; i < ATTRIBUTE_COMPOUND_IO_ATTR_DIMS; i++) {
            rbuf[i].a = -1;
    ...
    SUBTEST_BEGIN(params, "H5Awrite with compound member b then H5Aread with all compound members")
    {
        /* Initialize wbuf */
        for (i = 0; i < ATTRIBUTE_COMPOUND_IO_ATTR_DIMS; i++) {
 ...
 */
static herr_t
test_attribute_string_encodings(TestParams_t *params)
{
    hid_t   file_id                               = H5I_INVALID_HID;
    hid_t   container_group                       = H5I_INVALID_HID;
 ...
 */
static herr_t
test_delete_attribute(TestParams_t *params)
{
    htri_t attr_exists;
    hid_t  file_id         = H5I_INVALID_HID;
    hid_t  container_group = H5I_INVALID_HID;
    ...
    SUBTEST_BEGIN(params, "H5Adelete")
    {
        /* Test H5Adelete */
    ...
    SUBTEST_BEGIN(params, "H5Adelete_by_name")
    {
    ...
    SUBTEST_BEGIN(params, "H5Adelete_by_idx by creation order in increasing order")
    {
        if (!(vol_cap_flags_g & H5VL_CAP_FLAG_CREATION_ORDER)) {
            TESTFRAME_SKIPPED(params);
            printf("    creation order tracking isn't supported with this VOL connector\n");
    ...
    SUBTEST_BEGIN(params, "H5Adelete_by_idx by creation order in decreasing order")
    {
        if (!(vol_cap_flags_g & H5VL_CAP_FLAG_CREATION_ORDER)) {
            TESTFRAME_SKIPPED(params);
            printf("    creation order tracking isn't supported with this VOL connector\n");
    ...
    SUBTEST_BEGIN(params, "H5Adelete_by_idx by alphabetical order in increasing order")
    {
        /* Create several attributes */
        if ((attr_id = H5Acreate2(group_id, ATTRIBUTE_DELETION_TEST_ATTR_NAME, attr_dtype, space_id,
                                  H5P_DEFAULT, H5P_DEFAULT)) < 0) {
    ...
    SUBTEST_BEGIN(params, "H5Adelete_by_idx by alphabetical order in decreasing order")
    {
        /* Create several attributes */
        if ((attr_id = H5Acreate2(group_id, ATTRIBUTE_DELETION_TEST_ATTR_NAME, attr_dtype, space_id,
                                  H5P_DEFAULT, H5P_DEFAULT)) < 0) {
 ...
 */
static herr_t
test_delete_attribute_invalid_params(TestParams_t *params)
{
    herr_t err_ret = -1;
    htri_t attr_exists;
    hid_t  file_id         = H5I_INVALID_HID;
    ...
    SUBTEST_BEGIN(params, "H5Adelete with an invalid loc_id")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Adelete with an invalid attribute name")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Adelete_by_name with an invalid loc_id")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Adelete_by_name with an invalid object name")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Adelete_by_name with an invalid attribute name")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Adelete_by_name with an invalid LAPL")
    {
        H5E_BEGIN_TRY
        {
            err_ret = H5Adelete_by_name(group_id, ".", ATTRIBUTE_DELETION_INVALID_PARAMS_TEST_ATTR_NAME,
    ...
    SUBTEST_BEGIN(params, "H5Adelete_by_idx with an invalid loc_id")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Adelete_by_idx with an invalid object name")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Adelete_by_idx with an invalid index type")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Adelete_by_idx with an invalid index ordering")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Adelete_by_idx with an invalid LAPL")
    {
        H5E_BEGIN_TRY
        {
 ...
 */
static herr_t
test_attribute_exists(TestParams_t *params)
{
    htri_t attr_exists;
    hid_t  file_id         = H5I_INVALID_HID;
    hid_t  container_group = H5I_INVALID_HID;
    ...
    SUBTEST_BEGIN(params, "H5Aexists")
    {
    ...
    SUBTEST_BEGIN(params, "H5Aexists_by_name")
    {
 ...
 */
static herr_t
test_attribute_exists_invalid_params(TestParams_t *params)
{
    herr_t err_ret = -1;
    htri_t attr_exists;
    hid_t  file_id         = H5I_INVALID_HID;
    ...
    SUBTEST_BEGIN(params, "H5Aexists with an invalid loc_id")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Aexists with invalid attribute name")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Aexists_by_name with an invalid loc_id")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Aexists_by_name with invalid object name")
    {
        H5E_BEGIN_TRY
        {
            err_ret =
    ...
    SUBTEST_BEGIN(params, "H5Aexists_by_name with invalid attribute name")
    {
        H5E_BEGIN_TRY
        {
    ...
    SUBTEST_BEGIN(params, "H5Aexists_by_name with an invalid link access property list")
    {
        H5E_BEGIN_TRY
        {
 ...
 */
static herr_t
test_attribute_many(TestParams_t *params)
{
    unsigned u;
    htri_t   attr_exists;
    hid_t    file_id         = H5I_INVALID_HID;
 ...
 */
static herr_t
test_attribute_duplicate_id(TestParams_t *params)
{
    htri_t attr_exists;
    hid_t  file_id         = H5I_INVALID_HID;
    hid_t  container_group = H5I_INVALID_HID;
 ...
 */
static herr_t
test_get_number_attributes(TestParams_t *params)
{
    ...
    SUBTEST_BEGIN(params, "H5Oget_info")
    {
    ...
    SUBTEST_BEGIN(params, "H5Oget_info_by_name")
    {
 ...
 */
static herr_t
test_attr_shared_dtype(TestParams_t *params)
{
    H5O_info2_t obj_info;
    htri_t      attr_exists;
    hid_t       file_id         = H5I_INVALID_HID;
