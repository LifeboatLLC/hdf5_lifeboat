...
static herr_t test_multi_file_dataset_io(TestParams_t *params);
static herr_t test_multi_file_grp_dset_io(TestParams_t *params);
static herr_t test_set_extent(TestParams_t *params);
static herr_t test_attribute_exists(TestParams_t *params);
static herr_t test_attribute_io(TestParams_t *params);
static herr_t test_attribute_io_tconv(TestParams_t *params);
static herr_t test_attribute_io_compound(TestParams_t *params);
static herr_t test_group(TestParams_t *params);
static herr_t test_link(TestParams_t *params);
static herr_t test_ocopy_orefresh(TestParams_t *params);
static herr_t test_file_reopen(TestParams_t *params);
static herr_t test_file_cleanup(TestParams_t *params);
 ...
 */
static herr_t
test_one_dataset_io(TestParams_t *params)
{
 ...
 */
static herr_t
test_multi_dataset_io(TestParams_t *params)
{
    hid_t file_id    = H5I_INVALID_HID;
 ...
 */
static herr_t
test_multi_file_dataset_io(TestParams_t *params)
{
 ...
 */
static herr_t
test_multi_file_grp_dset_io(TestParams_t *params)
{
    hid_t   file_id  = H5I_INVALID_HID;
 ...
 */
static herr_t
test_set_extent(TestParams_t *params)
{
    hid_t   file_id       = H5I_INVALID_HID;
    hid_t   dset_id       = H5I_INVALID_HID;
    ...
    for (i = 0; i < 6; i++)
        for (j = 0; j < 10; j++)
            if (wbuf[i][j] != rbuf[i][j])
                TESTFRAME_FAIL_PUTS_ERROR(params, "    data verification failed\n");
 ...
 */
static herr_t
test_attribute_io(TestParams_t *params)
{
    hid_t   file_id  = H5I_INVALID_HID;
    hid_t   dset_id  = H5I_INVALID_HID;
    hid_t   attr_id  = H5I_INVALID_HID;
 ...
 */
static herr_t
test_attribute_io_tconv(TestParams_t *params)
{
    hid_t   file_id  = H5I_INVALID_HID;
    hid_t   attr_id  = H5I_INVALID_HID;
    hid_t   space_id = H5I_INVALID_HID;
...
static herr_t
test_attribute_io_compound(TestParams_t *params)
{
    hid_t        file_id   = H5I_INVALID_HID;
    hid_t        attr_id   = H5I_INVALID_HID;
    hid_t        space_id  = H5I_INVALID_HID;
 ...
 */
static herr_t
test_group(TestParams_t *params)
{
    hid_t      file_id         = H5I_INVALID_HID;
 ...
 */
static herr_t
test_ocopy_orefresh(TestParams_t *params)
{
    hid_t   file_id         = H5I_INVALID_HID;
    hid_t   parent_group_id = H5I_INVALID_HID;
    hid_t   dset_id         = H5I_INVALID_HID;
 ...
 */
static herr_t
test_file_reopen(TestParams_t *params)
{
    hid_t  file_id          = H5I_INVALID_HID;
 ...
 */
static herr_t
test_file_cleanup(TestParams_t H5_ATTR_UNUSED *params)
{
    char file_name[64];
    int  i;
