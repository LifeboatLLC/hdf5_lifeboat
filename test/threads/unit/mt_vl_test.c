 ...
 * threads. */
herr_t
mt_test_registration(TestParams_t *args)
{
    hid_t                *vol_ids;
    herr_t                ret       = SUCCEED;
 ...
 * threads. */
herr_t
mt_test_registration_by_name(TestParams_t *args)
{
 ...
 * threads. */
herr_t
mt_test_registration_by_value(TestParams_t *args)
{
#ifndef H5_MT_TEST_VOL_DIR
    printf("Skipping test because H5_MT_TEST_VOL_DIR is not defined\n");
    return;
...
herr_t
mt_test_dyn_op_registration(TestParams_t H5_ATTR_UNUSED *args)
{
...
herr_t
mt_test_registration_operation(TestParams_t *args)
{
...
herr_t
mt_test_registration_operation_cleanup(TestParams_t H5_ATTR_UNUSED *args)
{
    herr_t ret = SUCCEED;
...
herr_t
mt_test_file_open_failure_registration(TestParams_t H5_ATTR_UNUSED *args)
{
#ifndef H5_MT_TEST_VOL_DIR
    printf("Skipping test because H5_MT_TEST_VOL_DIR is not defined\n");
    return;
 ...
 * correctly */
herr_t
mt_test_vol_property_copy(TestParams_t *args)
{
    hid_t  fapl_id = H5I_INVALID_HID;
    herr_t ret     = SUCCEED;
 ...
 */
herr_t
mt_test_register_and_search(TestParams_t *args)
{
...
herr_t
mt_test_lib_state_ops(TestParams_t H5_ATTR_UNUSED *args)
{
    void  *lib_state = NULL;
    herr_t ret       = SUCCEED;
...
herr_t
mt_test_vol_wrap_ctx(TestParams_t *args)
{
    hid_t  file_id         = H5I_INVALID_HID;
    herr_t ret             = SUCCEED;
    hid_t  fapl_id         = H5I_INVALID_HID;
...
herr_t
mt_test_vol_wrap_ctx_cleanup(TestParams_t H5_ATTR_UNUSED *args)
{
 ...
 * so should probably have a counterpart placed in the API tests for use with various VOL connectors. */
herr_t
mt_test_vol_info(TestParams_t H5_ATTR_UNUSED *args)
{
