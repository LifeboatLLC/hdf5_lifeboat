...
static int  clear_type(id_type_t *id_type_ptr, hbool_t force, hbool_t cs, hbool_t ds, hbool_t rpt_failures,
                       int tid);
static void try_clear_type(int type_index, hbool_t force, hbool_t cs, hbool_t ds, hbool_t rpt_failures,
                           int tid);
...
static void   try_register_id(int id_index, int obj_index, hbool_t cs, hbool_t ds, hbool_t rpt_failures,
                              int tid);
...
static int    reserve_future_id(id_type_t *id_type_ptr, id_instance_t *id_inst_ptr,
                                H5I_progress_func_t progress_cb, hbool_t cs, hbool_t ds, hbool_t rpt_failures,
                                int tid);
static void   try_reserve_future_id(int id_index, H5I_progress_func_t progress_cb, hbool_t cs, hbool_t ds,
...
static herr_t define_future_0(id_type_t *id_type_ptr, id_instance_t *id_inst_ptr, id_object_t *id_object_ptr,
                              hbool_t cs, hbool_t ds, hbool_t rpt_failures, int tid);
static int    try_define_future_id(int id_index, int obj_index, hbool_t cs, hbool_t ds, hbool_t rpt_failures,
                                   int tid);
...
static int    get_type(id_type_t *id_type_ptr, id_instance_t *id_inst_ptr, hbool_t cs, hbool_t ds,
                       hbool_t rpt_failures, int tid);
...
static int    dec_ref(id_type_t *id_type_ptr, id_instance_t *id_inst_ptr, id_object_t *id_obj_ptr, hbool_t cs,
...
static int create_types(int types_start, int types_count, int types_stride, hbool_t cs, hbool_t ds,
                        hbool_t rpt_failures, int tid);
static int dec_type_refs(int types_start, int types_count, int types_stride, hbool_t cs, hbool_t ds,
                         hbool_t rpt_failures, int tid);
static int inc_type_refs(int types_start, int types_count, int types_stride, hbool_t cs, hbool_t ds,
                         hbool_t rpt_failures, int tid);
static int destroy_types(int types_start, int types_count, int types_stride, hbool_t cs, hbool_t ds,
                         hbool_t rpt_failures, int tid);

static int register_ids(int types_start, int types_count, int types_stride, int ids_start, int ids_count,
                        int ids_stride, hbool_t cs, hbool_t ds, hbool_t rpt_failures, int tid);
static int define_futures_0(int types_start, int types_count, int types_stride, int ids_start, int ids_count,
                            int ids_stride, hbool_t cs, hbool_t ds, hbool_t rpt_failures, int tid);
static int reserve_future_ids(int types_start, int types_count, int types_stride, int ids_start,
                              int ids_count, int ids_stride, H5I_progress_func_t progress_cb, hbool_t cs,
                              hbool_t ds, hbool_t rpt_failures, int tid);
static int dec_refs(int types_start, int types_count, int types_stride, int ids_start, int ids_count,
                    int ids_stride, hbool_t cs, hbool_t ds, hbool_t rpt_failures, int tid);
static int inc_refs(int ids_start, int ids_count, int ids_stride, hbool_t cs, hbool_t ds,
                    hbool_t rpt_failures, int tid);
static int verify_objects(int types_start, int types_count, int types_stride, int ids_start, int ids_count,
                          int ids_stride, hbool_t cs, hbool_t ds, hbool_t rpt_failures, int tid);
...
free_func(void *obj, void H5_ATTR_UNUSED **request)
{
     ...
     */
    if ((obj_k.in_progress) || (!obj_k.allocated) || (obj_k.discarded)) {
    ...
    do {
        ...
        inst_done =
            atomic_compare_exchange_strong(&(id_instance_array[id_index].k), &id_inst_k, mod_id_inst_k);
 ...
 ***********************************************************************************************/
static int
reserve_future_id(id_type_t *id_type_ptr, id_instance_t *id_inst_ptr, H5I_progress_func_t progress_cb,
                  hbool_t cs, hbool_t ds, hbool_t rpt_failures, int tid)
{
    hbool_t              success = TRUE;
    H5I_type_t           type;
    ...
    if ((id_type_k.in_progress) || (!id_type_k.created) || (id_type_k.discarded)) {
        ...
        if (rpt_failures) {
            ...
            fprintf(stderr,
                    "reserve_future_id():%d: target id type either in progress, not created, or discarded on "
                    "entry.\n",
                    tid);
        }
    }
    ...
    if (success) {
        if ((id_inst_k.in_progress) || (id_inst_k.created) || (id_inst_k.discarded)) {
            ...
            if (rpt_failures) {
                ...
                fprintf(stderr,
                        "reserve_future_id():%d: target id inst in progress, not created, or discarded on "
                        "entry.\n",
                        tid);
            }
        }
    ...
    if (success) {
        ...
        if (!atomic_compare_exchange_strong(&(id_inst_ptr->k), &id_inst_k, mod_id_inst_k)) {
            ...
            if (rpt_failures) {
                ...
                fprintf(stderr,
                        "reserve_future_id():%d: Can't update id instance for id registration success or "
                        "failure.\n",
                        tid);
            }
        }
 ...
 ***********************************************************************************************/
static void
try_reserve_future_id(int id_index, H5I_progress_func_t progress_cb, hbool_t cs, hbool_t ds,
                      hbool_t rpt_failures, int tid)
{
    hbool_t              success = TRUE; /* will set to FALSE on failure */
    int                  type_index;
    ...
    if (success) {
        if ((id_inst_k.in_progress) || (id_inst_k.created) || (id_inst_k.discarded)) {
            ...
            if (rpt_failures) {
                ...
                fprintf(stderr,
                        "try_reserve_future_id():%d: target id inst in progress, not created, or discarded "
                        "on entry.\n",
                        tid);
            }
    ...
    if (success) {
        ...
        if (!atomic_compare_exchange_strong(&(id_instance_array[id_index].k), &id_inst_k, mod_id_inst_k)) {
            ...
            if (rpt_failures) {
                ...
                fprintf(stderr,
                        "try_reserve_future_id():%d: Can't update id instance for future id reservation "
                        "success or failure.\n",
                        tid);
            }
...
static int
define_future_0(id_type_t *id_type_ptr, id_instance_t *id_inst_ptr, id_object_t *id_obj_ptr, hbool_t cs,
                hbool_t ds, hbool_t rpt_failures, int tid)
{
    hbool_t              success = TRUE; /* will set to FALSE on failure */
    H5I_type_t           type;
    ...
    if ((id_type_k.in_progress) || (!id_type_k.created) || (id_type_k.discarded)) {
        ...
        if (rpt_failures) {
            ...
            fprintf(stderr,
                    "define_future_0():%d: target id type either in progress, not created, or discarded on "
                    "entry.\n",
                    tid);
        }
    }
    ...
    if (success) {
        if ((id_inst_k.in_progress) || (id_inst_k.discarded)) {
            ...
            if (rpt_failures) {
                ...
                fprintf(stderr, "define_future_0():%d: target id inst in progress or discarded on entry.\n",
                        tid);
            }
        }
    }
    ...
    if (success) {
        ...
        if (!atomic_compare_exchange_strong(&(id_inst_ptr->k), &id_inst_k, mod_id_inst_k)) {
            ...
            if (rpt_failures) {
                ...
                fprintf(stderr,
                        "define_future_0():%d: Can't update id instande for id registration success or "
                        "failure.\n",
                        tid);
            }
        }
...
static int
try_define_future_id(int id_index, int obj_index, hbool_t cs, hbool_t ds, hbool_t rpt_failures, int tid)
{
    hbool_t              success    = TRUE;
    hbool_t              done       = FALSE;
    int                  ambiguous  = 0;
        ...
        while (!done) {
            ...
            if ((!id_inst_k.created) || (id_inst_k.discarded) || (!id_inst_k.future) || (id_inst_k.closing)) {
                ...
                if (rpt_failures) {
                    ...
                    fprintf(stderr,
                            "try_define_future_id():%d: target id:%d already created, discarded, realized.\n",
                            tid, id_index);
                }
                break;
            }
    ...
    if (success) {
        ...
        while (!done) {
            ...
            if ((id_obj_k.discarded) || (id_obj_k.allocated)) {
                ...
                if (rpt_failures) {
                    fprintf(stderr,
                            "try_define_future_id():%d: target id obj in progress, not created, or discarded "
                            "on entry.\n",
                            tid);
                }
                break;
...
try_object_verify(int id_index, hbool_t cs, hbool_t ds, hbool_t rpt_failures, int tid)
{
    ...
    if (success) {
        ...
        if ((!pre_id_inst_k.created) && (!post_id_inst_k.created)) {
            ...
            if (((pre_remove_verify_starts > 0) || (post_remove_verify_starts > 0)) && (!success)) {
                ...
                if (rpt_failures) {
                    ...
                    fprintf(stderr, "try_object_verify(%d):%d failure possibly explained by closing flag.\n",
                            id_index, tid);
                }
            }
            else {
                ...
                if (pre_id_inst_k.closings_attempted == post_id_inst_k.closings_attempted) {
                    ...
                    if (rpt_failures) {
                        ...
                        fprintf(stderr,
                                "try_object_verify(%d):%d failure possibly explained by a remove verify "
                                "closing the ID.\n",
                                id_index, tid);
                    }
                }
        ...
        else if (((pre_id_inst_k.discarded) && (post_id_inst_k.discarded)) || (!pre_id_inst_k.created)) {
        ...
        if ((!pre_id_inst_k.created) && (!post_id_inst_k.created)) {
            ...
            if (((0 < pre_remove_verify_starts) || (0 < post_remove_verify_starts)) && (!success)) {
                ...
                if (rpt_failures) {
                    ...
                    fprintf(stderr, "try_remove_verify(%d):%d failure possibly explained by closing flag.\n",
                            id_index, tid);
                }
            }
            else {
                ...
                if ((!post_id_inst_k.future)) {
                    ...
                    if (SUCCEED != update_freed_future(id_index)) {
                        ...
                        if (rpt_failures) {
                            ...
                            fprintf(
                                stderr,
                                "try_remove_verify():%d: update_freed_future() failed -- id index = %d.\n",
                                tid, id_index);
                        }
                        assert(FALSE);
                    }
        ...
        if (((!pre_id_inst_k.created) && (!post_id_inst_k.created)) ||
            ...
            if (((0 < pre_remove_verify_starts) || (0 < post_remove_verify_starts)) && (ref_count <= 0)) {
                ...
                if (rpt_failures) {
                    ...
                    fprintf(stderr, "try_dec_ref(%d):%d failure possibly explained by closing flag.\n",
                            id_index, tid);
                }
            }
            else {
        ...
        if ((pre_id_inst_k.created) && (post_id_inst_k.created) && (!pre_id_inst_k.discarded) &&
            ...
            if (((0 < pre_remove_verify_starts) || (0 < post_remove_verify_starts)) && (!success)) {
                ...
                if (rpt_failures) {
                    ...
                    fprintf(stderr,
                            "try_inc_ref(%d):%d: failure possibly caused by a concurrent remove verify.\n",
                            id_index, tid);
                }
            }
            else if (post_id_inst_k.closing) {
                ...
                if (rpt_failures) {
                    ...
                    fprintf(stderr, "try_inc_ref(%d):%d failure possibly explained by closing flag.\n",
                            id_index, tid);
                }
            }
            else {
        ...
        if ((pre_id_inst_k.created) && (post_id_inst_k.created) && (!pre_id_inst_k.discarded) &&
            ...
            if (((pre_remove_verify_starts > 0) || (post_remove_verify_starts > 0)) && (!success)) {
                ...
                if (rpt_failures) {
                    ...
                    fprintf(stderr, "try_get_ref(%d):%d failure possibly explained by closing flag.\n",
                            id_index, tid);
                }
            }
            else {
 ...
 ***********************************************************************************************/
static int
define_futures_0(int types_start, int types_count, int types_stride, int ids_start, int ids_count,
                 int ids_stride, hbool_t cs, hbool_t ds, hbool_t rpt_failures, int tid)
{
    int err_cnt = 0;
    int j;
    ...
    for (n = 0; n < ids_count; n++) {
        ...
        err_cnt += define_future_0(&(types_array[i]), &(id_instance_array[j]), &(objects_array[j]), cs, ds,
                                   rpt_failures, tid);
    ...
    if ((err_cnt > 0) && (rpt_failures)) {
        ...
        fprintf(stderr,
                ...
                err_cnt, types_start, types_count, types_stride, ids_start, ids_count, ids_stride);
    }
...
static int
reserve_future_ids(int types_start, int types_count, int types_stride, int ids_start, int ids_count,
                   int ids_stride, H5I_progress_func_t progress_cb, hbool_t cs, hbool_t ds,
                   hbool_t rpt_failures, int tid)
{
    int err_cnt = 0;
    int n;
    ...
    for (n = 0; n < ids_count; n++) {
        ...
        err_cnt += reserve_future_id(&(types_array[i]), &(id_instance_array[j]), progress_cb, cs, ds,
                                     rpt_failures, tid);
    }
...
future_serial_test_1(TestParams_t H5_ATTR_UNUSED *params)
{
    ...
    for (i = 0; i < 128; i += 2) {
        ...
        err_cnt +=
            reserve_future_id(&(types_array[0]), &(id_instance_array[i]), NULL, cs, ds, rpt_failures, tid);
    ...
    for (i = 0; i < 128; i += 2 * 8) {
        ...
        err_cnt += define_future_0(&(types_array[0]), &(id_instance_array[i]), (void *)&objects_array[i], cs,
                                   ds, rpt_failures, tid);
    }
    ...
    for (i = 0; i < 128; i += 2) {
        ...
        if (0 == i % 16) {
            ...
            err_cnt +=
                object_verify(&(types_array[0]), &(id_instance_array[i]), NULL, cs, ds, rpt_failures, tid);
        }
...
future_serial_test_2(TestParams_t H5_ATTR_UNUSED *params)
{
    ...
    for (i = 0; i < 128; i += 2) {
        ...
        err_cnt += define_future_0(&(types_array[0]), &(id_instance_array[i]), &(objects_array[i]), cs, ds,
                                   rpt_failures, tid);
    }
    ...
    for (i = 0; i < 128; i += 2) {
        ...
        err_cnt +=
            dec_ref(&(types_array[0]), &(id_instance_array[i]), &(objects_array[i]), cs, ds, TRUE, tid);
    ...
    if (display_op_stats) {
        ...
        H5I_dump_nz_stats(stdout,
                          "decrement (really delete) realized futures (real IDs) ref counts 1 -- test b");
...
mt_future_test_fcn_1(void *_params)
{
    ...
    if (show_progress) {
        ...
        fprintf(stderr,
                "mt_future_test_fcn_1:%d: params st/cnt/st = %d/%d/%d, id st/cnt/st = %d/%d/%d, obj "
                "st/cnt/st = %d/%d/%d\n",
                params->thread_id, params->types_start, params->types_count, params->types_stride,
                params->ids_start, params->ids_count, params->ids_stride, params->objects_start,
                params->objects_count, params->objects_stride);
        ...
        while ((proceed) && (ids_completed < params->ids_count)) {
            ...
            if (0 == id_op_counts[target_id_index]) {
                ...
                if (types_assigned[target_id_type_index]) {
                    ...
                    assert(0 ==
                           atomic_load(&(id_instance_array[target_id_index].successful_future_reserves)));
                    assert(0 == atomic_load(&(id_instance_array[target_id_index].failed_future_reserves)));

                    /* use the same index for the object as the instance */
                    try_reserve_future_id(target_id_index, future_progress_cb, params->cs, params->ds,
                                          params->rpt_failures, params->thread_id);
...
mt_future_test_fcn_3(void *_params)
{
    ...
    if (show_progress) {
        ...
        fprintf(stderr,
                "mt_future_test_fcn_3:%d: type st/cnt/st = %d/%d/%d, id st/cnt/st = %d/%d/%d, obj st/cnt/st "
                "= %d/%d/%d\n",
                params->thread_id, params->types_start, params->types_count, params->types_stride,
                params->ids_start, params->ids_count, params->ids_stride, params->objects_start,
                params->objects_count, params->objects_stride);
        ...
        while ((proceed) && (ids_completed < params->ids_count)) {
            ...
            if (0 == id_op_counts[target_id_index]) {
                ...
                if (types_assigned[target_id_type_index]) {
                    ...
                    /* use the same index for the object as the instance */
                    try_reserve_future_id(target_id_index, NULL, params->cs, params->ds, params->rpt_failures,
                                          params->thread_id);
...
mt_test_fcn_1_serial_test(TestParams_t *_params)
{
    ...
    err_cnt += create_types(params->types_start, params->types_count, params->types_stride, params->cs,
                            params->ds, params->rpt_failures, params->thread_id);
    ...
    while (!atomic_load(&(test_definer_stop))) {
        ...
        if (did_work == 0) {
            ...
            for (i = 0; i < H5I_TEST_SCAN_BUDGET; i++) {
                ...
                if ((!inst_k.created) || (inst_k.discarded) || (!inst_k.future) || (inst_k.realized) ||
                    (inst_k.closing) || (inst_k.in_progress))
                    continue;
                ...
                future_progress_queue_push(
                    id_index, (H5I_TEST_MAX_DELAY > 0) ? (rand() % (H5I_TEST_MAX_DELAY + 1)) : 0);
            }
        }
...
main(int argc, char **argv)
{
    ...
    test_params = (mt_test_params_t){/* thread_id      = */ 0,
                                     /* types_start    = */ 0,
                                     /* types_count    = */ 32,
                                     /* types_stride   = */ 1,
                                     /* ids_start      = */ 0,
    ...
    AddTest("serial_test_2", serial_test_2, NULL, reset_globals, &test_params, sizeof(mt_test_params_t), 0,
            "smoke check test for H5I ID registrations");
    ...
    AddTest("mt_test_fcn_1_serial_test", mt_future_test_fcn_1_serial_test, NULL, reset_globals, &test_params,
            sizeof(mt_test_params_t), 0, "serial smoke check test for multi-thread helper function");
    ...
    AddTest("mt_test_fcn_1_serial_test", mt_test_fcn_1_serial_test, NULL, reset_globals, &test_params,
            sizeof(mt_test_params_t), 0, "serial smoke check test for multi-thread helper function");

    AddTest("mt_test_1", mt_test_1, NULL, NULL, NULL, 0, 0, "multi-thread H5I smoke check test #1");

    AddTest("mt_test_2", mt_test_2, NULL, NULL, NULL, 0, 0, "multi-thread H5I smoke check test #2");
